    ...
    <div class="page-content-wrapper ">
        <div class="container-fluid">
            ...
            <div class="card m-b-30 card-body">
                <h4 class="card-title font-20 mt-0">Create Attribute</h4>
            ...
            <div class="card m-b-30">
                <form action="{{route('attribute.store')}}" method="POST">
                    ...
                    <div id="attribute" class="content"data-mfield-options='{"section": ".group","btnAdd":"#btnAdd-1","btnRemove":".btnRemove"}'>
                        <div class="col-md-12">
                            <!-- <button type="button" id="btnAdd-1" class="btn btn-sm my-2 btn-primary">Add</button> -->
                        </div>
                        <div class=" container-fluid row group">
                            <div class="col-sm-6">
                            <label for="">Attribute Type</label>
                            <!-- <select name="attribute_type"  class="form-control form-control-sm cat_id ">
                            <option value="">Select</option>
                            <option value="size">Size</option>
                            <option value="color">Color</option>
                            </select> -->
                            <input class="form-control " name="attribute_type" type="text">
                            ...
                            <!-- <input class="form-control " step="any" name="value[]" type="text"> -->
