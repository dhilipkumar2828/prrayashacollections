                        ...
                        <table id="example" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                @php
                                    ...
                                    $product1=DB::table('product_variants')->where('product_id',$pro->id)->first();
                                    $photo ='';
                                    if(!empty($product1)){
                                ...
                                <tr>
                                    <td><img src="{{$photo}}"alt="banner image" style="max-height: 90px;max-width:120px"></td>
                                    <td>{{$pro->name}} </td>
                                    <td>
                                    <?php 
                                    ...
                                    <img src='#' alt=''style='max-height: 250px;max-width:250px' id='photo'>
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label">Sub Category</label>
                                                        <div class="col-sm-10" id="sub_category"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label">Brands</label>
...
$(document).ready(function () {
    $('#example').DataTable({
        ...
        order: [[0, 'desc']], // Initial sorting of the table
