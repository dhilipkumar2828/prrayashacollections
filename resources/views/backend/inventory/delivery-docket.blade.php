                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted m-b-30 font-14">Parsley is a javascript form validation
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div >
                                                            @if(count(\App\Models\Inventory::orderBy('id','DESC')->limit('1')->get('id')) > 0)             
                                                                ...
                                                                <input class="form-control" type="text" name="delivery_number"  placeholder="Enter" value="Receiving-0000{{(explode('-',$item->delivery_number)[1]+1)}}" readonly id="example-text-input">
                                                                @endforeach
                                                           @else
                                                            <input class="form-control" type="text" name="delivery_number"  placeholder="Enter" value="Receiving-00001" readonly id="example-text-input">
                                                           @endif            
                                                           </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input data-parsley-type="alphanum" required name="deliverer" type="text" class="form-control"  placeholder="Deliverer"/>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="" action="#">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <div class="input-group">
                                                            <input type="date" class="form-control" required name="accounting_date" placeholder="mm/dd/yyyy" id="datepicker">
                                                        </div><!-- input-group -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <div class="input-group">
                                                            <input type="date" class="form-control" required name="voucher_date" placeholder="mm/dd/yyyy" id="datepicker">
                                                        </div><!-- input-group -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input  type="text" class="form-control"  required id="invoice_val"  placeholder="Invoice Number"/>
                                                        <input  type="hidden" class="form-control"  name="invoice_id" id="invoice_id"  placeholder="Invoice Number"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <div class="input-group">
                                                            <input type="date" class="form-control" required name="expiry_date" placeholder="mm/dd/yyyy" id="datepicker">
                                                        </div><!-- input-group -->
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group col-lg-6" >
                                                ...
                                                <div>
                                                    <input type="text" class="form-control" required id="total_tax" name="total_tax"
                                                           placeholder="0.00"/>
                                                </div>
                                            </div>
