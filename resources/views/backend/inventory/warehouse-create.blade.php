                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            @if(count(\App\Models\Warehouse::orderBy('id','DESC')->limit('1')->get('id'))
                                            > 0)
                                            @foreach(\App\Models\Warehouse::orderBy('id','DESC')->limit('1')->get('warehouse_code')
                                            as $item)
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="js-example-basic-single" name="business_days[]" id="business_days" required
                                                placeholder="Select" style="width:100%;" multiple="multiple">
