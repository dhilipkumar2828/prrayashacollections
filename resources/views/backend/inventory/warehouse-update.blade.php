                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('warehouse.update',$warehouse->id)}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-12 col-form-label">Email
                                            Address</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" value="{{$warehouse->email_address}}" name="email_address"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="phone"
                                                placeholder="Enter Phone Number" value="{{$warehouse->phone}}" id="example-text-input">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-6 col-form-label">Business
                                            Days</label>
                                        <div class="col-sm-10">
                                            <select class="js-example-basic-single" name="business_days[]" id="business_days" required
                                                placeholder="Select" style="width:100%;" value="{{$warehouse->business_days}}" multiple="multiple">
                                                <option value="Sat" {{ (in_array('Sat',explode(',',$warehouse->business_days))) ? 'selected' : '' }}>Saturday</option>
                                                <option value="Sun" {{ (in_array('Sun',explode(',',$warehouse->business_days))) ? 'selected' : '' }}>Sunday</option>
                                                <option value="Mon" {{ (in_array('Mon',explode(',',$warehouse->business_days))) ? 'selected' : '' }}>Monday</option>
                                                <option value="Tues" {{ (in_array('Tues',explode(',',$warehouse->business_days))) ? 'selected' : '' }}>Tuesday</option>
                                                <option value="Wed" {{ (in_array('Wed',explode(',',$warehouse->business_days))) ? 'selected' : '' }}>Wednesday</option>
                                                <option value="Thurs" {{ (in_array('Thurs',explode(',',$warehouse->business_days))) ? 'selected' : '' }}>Thursday</option>
                                                <option value="Fri" {{ (in_array('Fri',explode(',',$warehouse->business_days))) ? 'selected' : '' }}>Friday</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-6 col-form-label">Opening
                                            Time</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="time" name="open_time"
                                                placeholder="Enter Opening time" value="{{$warehouse->close_time}}" id="example-text-input">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-6 col-form-label">Closing
                                            Time</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="time" name="close_time"
                                                placeholder="Enter Opening time" value="{{$warehouse->open_time}}" id="example-text-input">
                                        </div>
                                    </div>
                                </div>
