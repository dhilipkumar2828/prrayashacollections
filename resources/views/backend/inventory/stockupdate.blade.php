                        ...
                        <div id="product_attribute" class="content"
                            ...
                            <div class="col-md-12">
                               ...
                               <?php
                                   ...
                                   <div class="col-md-3"> <a href="{{route('viewstocklogs',$productvariant[$i]->id)}}" target="_blank">View Stock Logs</a>
                                 </div>
                                       </div>
                                   <?php }
                                   ?>
                            ...
                            <div class="col-md-12 tac">
                               ...
                               <select class="form-control" name="v_id" id="v_id">
                                   ...
                                   <?php
                                   for($i=0;$i<count($productvariant);$i++){?>
                                       <option value="{{$productvariant[$i]->id}}" data-stock="{{$productvariant[$i]->in_stock}}">{{$productvariant[$i]->variants}} - {{$productvariant[$i]->sku}}</option>
                                   <?php }
                                   ?>
                               </select>
                               </div>
                            ...
                            <div class="col-md-12">
                                 <div class="row">
                                     ...
                                     <div class="col-md-3">
                                          ...
                                          <div class="col-md-6">
                                           <input type="number" min="1" class="form-control" name="stockvalue" id="stockvalue" placeholder="Enter the Stock value which you want to add or reduce">
                                          </div>
        ...
        var currentStock = +($('#v_id').find(":selected").attr('data-stock'));
            ...
            if(stockOpr=="add"){
                ...
                if(stockval>currentStock){
                    $('#stockvalue').val('0');
                    swal("Current Stock is "+currentStock+", but trying to reduce "+stockval+" is not possible.");
                    return false;
                }
              ...
              swal({
                title: "Are you sure to want "+stockOpr+" "+stockval+" to this varient ?"+"New Stock will be "+newstock,
                text: 'Confirmation',
                icon: "warning",
                buttons: true,
                dangerMode: true,
