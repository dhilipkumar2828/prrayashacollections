                ...
                <div class="card-body" style="margin: 0px 50px; padding: 0px 60px;">
                                ...
                                <table style="width:100%;overflow: auto;">
                                  ...
                                  <tr>
                                    <td width="50%" rowspan="2">    <div class="company">
                                        ...
                                        <img src="https://prrayashacollections.com/frontend/img/Prrayasha Collection LOGO.jpeg" width="100%" class="squaree" alt="">
                                        </div>
                                ...
                                <table style="width:100%">
                                 ...
                                 Amount Chargable (in words): INR <?php echo numberToWords($total); ?>
                                    ...
                                    <table style="width:100%">
                                        ...
                                        <tr>
                                            <td class="text-end"> </td>
                                            <td class="text-end"> <img width="40%" src="https://taslim.oceansoftwares.in/prrayasha/public/frontend/img/sign.jpg"></td>
                                        </tr>
                    ...
                    <div class="row">
                         ...
                         <div class="btn-wrapper animated" style="text-align:center">
                            ...
                            <button onclick="download_pdf()" class="theme-btn-1 btn btn-effect-1 text-uppercase" id="printPageButton" data-html2canvas-ignore="true">Download</button>
                        </div>
