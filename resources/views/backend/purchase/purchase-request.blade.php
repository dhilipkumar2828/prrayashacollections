                                    ...
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                        ...
                                                        <td>
                                                            <div class="btn-group m-b-10">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                      @can('Purchase Edit')
                                                                    <a class="dropdown-item" href="{{route('purchase.edit',$item->id)}}">Edit</a>
                                                                    @endcan
                                                                    <form action="{{route('purchase.destroy',$item->id)}}" id="form-{{$item->id}}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                      @can('Purchase Delete')
                                                ...
                                                @if(\App\Models\Quotation::where(['purchase_request_id'=>$item->id])->count() != 1)
                                                                    <a class="btn waves-effect waves-light quotation" data-id="{{$item->id}}" 
                                                                        >Create Quotation</a>
                                                                        @endif                       
                                                                </div>
                                                            </div><!-- /btn-group -->
