                                                        ...
                                                        <td>
                                                            <div class="btn-group m-b-10">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    @can('Quotation View')
                                                                    <a class="dropdown-item" href="{{route('quotation.show',$item->qid)}}">View</a>
                                                                @endcan
                                                                    @if(\App\Models\Quotation::where(['purchase_request_id'=>$item->id,'status'=>'Approved'])->count() == 1)
                                                                  <form action="{{route('quotation.store')}}" method="post">
                                                                      @csrf
                                                                    <input type="hidden" name="purchase_request_id" value="{{$item->id}}">  
                                                                    <input type="hidden" name="quotation_id" value="{{$item->qid}}">  
                                                                ...
                                                                <input type="hidden" name="purchase_order_id"   value="PO-0000{{(explode('-',$item->purchase_order_id)[1]+1)}}" readonly>
                                                                @endforeach
                                                           @else
                                                            <input type="hidden" name="purchase_order_id"  value="PO-00001" readonly >
                                                           @endif   

                                                                    <button class="btn waves-effect waves-light order" type="submit" data-id="{{$item->id.'|'.$item->qid}}" 
                                                                        >Create Order</button>
                                                                  </form>      
                                                                    @endif    
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label">Purchase Request Code </label>
                                                                                <div class="col-sm-10">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label">Purchase Request Name</label>
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="example-text-input" disabled>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-6 col-form-label">Unit Price</label>
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="example-text-input" disabled>
                                                                                </div>
                                                                            </div>
