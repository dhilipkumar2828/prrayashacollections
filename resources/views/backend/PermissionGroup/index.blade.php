                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="float-right page-breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('permission_group.index')}}">Permission Group</a></li>
                                            ...
                                            <td>
                                                <div class="btn-group m-b-10">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item" href="{{route('permission_group.edit',$item->id)}}">Edit</a>
                                                        @endcan
                                                        <form action="{{route('permission_group.destroy',$item->id)}}" method="post">
                                                            @csrf
                                                            @method('delete')
