                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1"name="description"
                                            value="{{ $Brand->description }}">{{ $Brand->description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" required type="text" value="{{ $Brand->brand_logo }}" name="brand_logo">
                                        </div>
                                          <div id="holder" style="margin-top:15px;max-height:100px;"><img src="{{ $Brand->brand_logo }}" style="height: 5rem;"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail1" class="form-control" required type="text" value="{{ $Brand->cover_photo }}" name="cover_photo">
                                        </div>
                                          <div id="holder1" style="margin-top:15px;max-height:100px;"><img src="{{ $Brand->cover_photo }}" style="height: 5rem;"></div>
                                    </div>
                                </div>
