                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> {{$item->email}}</td>
                                            <td> <img src="{{$item->brand_logo}}" alt="Manufacturers image" style="max-height: 90px;max-width:120px"></td>
                                            ...
                                            <td>
                                                <div class="btn-group m-b-10">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="btn waves-effect waves-light view" data-toggle="modal"  data-id="{{$item->id}}"   data-dismiss="modal" data-target=".bs-example-modal-center1">View</a>
                                                    </div>
                                                </div><!-- /btn-group -->
                                            </td>
                                        </tr>
