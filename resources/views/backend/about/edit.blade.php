                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" required name="description"
                                            value="">{{ $aboutus->description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" required class="form-control" type="text" name="photo" value="{{$aboutus->photo}}">
                                          </div>
                                          <div id="holder" style="margin-top:15px;max-height:100px;"><img src="{{$aboutus->photo}}" alt="promo image"style="max-height: 90px;max-width:120px">
                                          </div>
                                        </div>
                                    </div>
                                    <div class="d-flex">
