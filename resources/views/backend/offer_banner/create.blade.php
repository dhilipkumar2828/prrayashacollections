                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <form action="{{url('offer_banner_store')}}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                          ...
                                          <div id="holder" class="holder" style="margin-top:15px;max-height:100px; display: flex">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="link" Placeholder="Enter Link" required id="example-search-input">
                                </div>
                            </div> 
