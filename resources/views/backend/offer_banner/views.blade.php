                                ...
                                <tr>
                                    ...
                                    <td> <img src="{{$d->photo}}" alt="banner image"
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a class="dropdown-item" href="{{url('offer_banner_edit').'/'.$d->id}}">Edit</a>
                                            @endcan
                                            @can('Offer Banner Delete')
                                            <form action="{{url('offer_banner_delete').'/'.$d->id}}" method="post">
                                                    @csrf                              
                                                    <a class="dltBtn btn waves-effect waves-light"  title="delete" data-id="{{$d->id}}" data-toggle="modal" data-dismiss="modal" data-target=".bs-example-modal-center">Delete</a><br>
                                            </form>   
                                            @endcan 
                                            </div>
                                        </div>
