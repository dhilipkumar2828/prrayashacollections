                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="invoice-title">
                                ...
                                <h3 class="m-t-0">
                                    <img src="{{asset('frontend/img/tulia-logo.png')}}" style="width: 7%;
                                          height: 50px;" alt="logo" height="22" />
                                </h3>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-6">
                                    <address>
                                        ...
                                        Payment Status : <span class="badge badge-pill badge @if($order->payment_status=='paid')
                                                ...
                                                @else
                                                text-danger  mr-2
                                                @endif">{{$sub_orders->payment_status}}</span><br>
...
@endphp
                                                ...
                                                @php
  $get_product=DB::table('products')->where('id',$datas->products_id)->first();
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-line text-right">₹{{$order->sub_total * ($order->tax_rate)}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="no-line"></td>
                                                    <td class="no-line"></td>
