...
button.dt-button.btn {
    margin: 0 5px; /* Ensure buttons have consistent spacing */
}
</style>
...
<div class="row">
      <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-6 col-form-label">Description <span class="text-danger">*</span></label>
                                        <div class="col-sm-10">
               ...
               <div id="err_head" style="color: red;font-family: 'FontAwesome';display:none">This field is required</div>
   </div>
          ...
          <div class="col-sm-12">
            <div class="dt-buttons btn-group" style="display:none;">
                ...
                <form action="{{route('import_file')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-secondary buttons-excel buttons-html5" tabindex="0" aria-controls="datatable-buttons"><span>Import</span></button>
                    ...
                    <button ype="submit"class="btn btn-secondary buttons-excel buttons-html5" tabindex="0" aria-controls="datatable-buttons"><span>Import</span></button>
                    <!-- {{-- <a class="btn btn-secondary buttons-excel buttons-html5" tabindex="0" aria-controls="datatable-buttons" href="#"><span>Excel</span></a>
                    <a class="btn btn-secondary buttons-pdf buttons-html5" tabindex="0" aria-controls="datatable-buttons" href="#"><span>PDF</span></a> --}} -->
                    <a class="btn btn-secondary buttons-pdf buttons-html5"tabindex="0" aria-controls="datatable-buttons" href="{{route('export_file')}}">Export</a>
                </form>
...
<!-- Search Input -->
<div class="d-flex align-items-center inputField">
  <input type="text" id="search-input" class="form-control" placeholder="Search...">
</div>

<!-- Go Back Button -->
<div class="d-flex justify-content-center align-items-center backBtn" style="flex: 0 0 auto;">
  <button class="btn btn-primary" onclick="window.location.href='https://prrayashacollections.com/product'">
    Go Back
  </button>
</div>
...
@media (max-width: 768px) {
  ...
  #search-input {
    ...
    display: block;
    position: relative;
    z-index: 9999;          /* make sure input is above other layers */
  }
                            ...
                            <tbody>
                                ...
                                @php
                                    ...
                                    if($pro->subcategory_id){
                                        ...
                                        $subcategory=DB::table('categories')->where('id',$pro->subcategory_id)->first();
                                    ...
                                    if($pro->childcategory_id){
                                        ...
                                        $childcategory=DB::table('categories')->where('id',$pro->childcategory_id)->first();
                                    ...
                                    $catstr=array();
                                     $subcatstr=array();
                                     $soldStock = DB::table('order_products')->join('orders','orders.id','order_products.order_id')
                                     ->where('orders.payment_status','paid')
                                     ->where('product_id',$pro->id)
                                     ->sum('order_products.quantity');
                                @endphp
                                <tr>
                                     <td><input type="checkbox" class="product-checkbox" value="{{ $pro->id }}"></td>
               
                                    <td><img src="{{url($Aproductimg_variant[$key])}}"alt="product image" style="max-height: 90px;max-width:120px"></td>
                                    <td>{{$pro->name}}</td>
                                    <td>

                                    @for($i=0;$i<count($cat);$i++)
                                             @php
                                    $category=DB::table('categories')->where('is_parent',0)->where('id',$cat[$i])->first();
                                    $subcategory=DB::table('categories')->where('is_parent','!=',0)->where('id',$cat[$i])->first();
                                    if(!empty($category))
                                    ...
                                    <!-- <td>{{$pro->size}} </td> -->
                                    @if(auth()->user()->can('products-edit'))
                                            <td><input type="checkbox" name="toogle" value="{{$pro->id}}" data-toggle="switchbutton" {{$pro->status=='active' ? 'checked':''}} data-onlabel="active" data-offlabel="inactive" data-size="sm" data-onstyle="success" data-offstyle="danger"></td>
                                    @endif
                                    @if(auth()->user()->can('products-edit') or auth()->user()->can('products-delete'))
                                    <td>
                                        @can('products-edit')
                                         <a href="{{route('product.edit',$pro->id)}}?clone=true"><i class="fa fa-eye" aria-hidden="true"></i> Clone</a> | 
                                          
                                                <a href="{{route('product.edit',$pro->id)}}"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a> |
                                                 <a href="{{route('updatestockmanually',$pro->id)}}"><i class="fa fa-tasks" aria-hidden="true"></i> Update Stocks</a>
                                            @endcan
                        ...
                        <div class="col-sm-6 col-md-12 m-t-30">
                            <div class="modal fade bs-example-modal-center1" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                    <img src='#' alt=''style='max-height: 250px;max-width:250px' id='photo'>
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label">Brand Name</label>
                                                        <div class="col-sm-10" id="brand_name"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label">MPN</label>
                                                        <div class="col-sm-10" id="mpn"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label">GTIN</label>
                                                        <div class="col-sm-10" id="gtin"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label">GTIN Type</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label">Manufactured</label>
                                                        <div class="col-sm-10" id="manufactured"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label">Tax</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10" id="pstatus">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="example-text-input"  class="col-sm-6 col-form-label">Conditions</label>
                                                        <div class="col-sm-10">
        ...
        buttons: [
            {
                ...
                text: 'Excel Export',
                exportOptions: {
                    columns: [0, 1, 2, 3, 4, 5, 6, 7, 8] // Specify columns to export (zero-based index)
                },
