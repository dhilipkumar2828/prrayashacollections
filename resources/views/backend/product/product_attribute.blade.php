                ...
                for (let k2 = 0; k2 < ($('#chil_cat_id3').val().length); k2++) {
                    ...
                    if (variant.indexOf(vid) == -1) {
                        ...
                        let details = '<div class="card border1" id="vchild' + vid +
                            ...
                            '<input type="text"  class="form-control" name="sku[]" required placeholder="SKU" value="'+tempsku+'" style="width:100%;" >' +
                    ...
                    if (arrtibute_name_len1 != '') {
                      ...
                      //  variant.push(data.variant_id);
                        ...
                        let details = '<div class="card border1" id="vchild' +data.variant_id +
                            ...
                            '<label for="example-text-input" class="col-sm-12 col-form-label">#' + data.variant_id + ' ' + arrtibute_name_len0 + '</label>' +
