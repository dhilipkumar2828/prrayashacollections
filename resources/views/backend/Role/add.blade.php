                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <div >
                                    <input type="checkbox" data-id="{{$permissionGroup->id}}" class="groupcheck">
                                     <label for=""><h4>{{$permissionGroup->name }}</h4></label>
                                        ...
                                        @if($permissionGroup->permissions->count())
                                            @foreach ($permissionGroup->permissions as $permission)
                                                 <div class="col-sm-10">
                                                     <input value="{{ $permission->id }}"  name="permission_ids[]" class="form-check-input pgroup{{$permissionGroup->id}}" type="checkbox">
