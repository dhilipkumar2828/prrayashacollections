                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <div class="form-check">
                                    <input type="checkbox" data-id="{{$permissionGroup->id}}"  id="gp{{$permissionGroup->id}}" class="groupcheck">
                                     <label for=""><h4>{{$permissionGroup->name }}</h4></label>
                                    </div>
                                            ...
                                            @foreach ($permissionGroup->permissions as $permission)
                                                 <div class="col-sm-10">
                                                     ...
                                                     @if (in_array($permission->id,$roles->permissions->pluck('id')->toArray()))
                                                           checked
                                                      {{$i++}}     
                                                     @endif value="{{ $permission->id }}" name="permission_ids[]" class="form-check-input pgroup{{$permissionGroup->id}}" type="checkbox">
