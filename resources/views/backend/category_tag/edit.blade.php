...
<div class="container-fluid">
    ...
    <div class="card m-b-30 card-body">
        ...
        <a href="{{route('categorytag.index')}}" id="add-btn" style="color: #ffffff;"><i class="fa fa-angle-left"
        ...
        <div class="col-12">
            <div class="card m-b-30">
                ...
                <form action="{{route('categorytag.update',$categorytag->id)}}" method="post">
                        ...
                        <label for="cate_tag" class="col-sm-2 col-form-label">Tag</label>
                        <div class="col-sm-10">
                            <select id="cate_tag" name="cate_tag" class="form-control">
                                <option value="0" selected>-- 0 --</option>
                                <option value="FC" {{$categorytag->cate_tag=='FC'?'selected':''}}>FC</option>
                                <option value="PP" {{$categorytag->cate_tag=='PP'?'selected':''}}>PP</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" required type="text" name="photo" value="{{$categorytag->photo}}">
                                          </div>
                                          <div id="holder" style="margin-top:15px;max-height:100px;"><img src="{{$categorytag->photo}}" alt="promo image"style="max-height: 90px;max-width:120px">
                                          </div>
                                        </div>
                                    </div>
                                    ...
                                    <option value="active" {{ $categorytag->status == 'active' ? 'selected' : '' }}>Active</option>

                                    <option value="inactive" {{ $categorytag->status == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="d-flex">
