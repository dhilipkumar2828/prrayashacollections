                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <form action="{{route('blog.update',$blogs->id)}}" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label"><span class="text-danger"></span>Description</label>
                                    <!-- <img src="assets/images/image.png" class="admin-image"> -->
                                    <div class="col-sm-10">
                                        <textarea id="elm1" required name="description"
                                            value="">{{ $blogs->description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" required class="form-control" type="text" name="photo" value="{{$blogs->photo}}">
                                          </div>
                                          <div id="holder" style="margin-top:15px;max-height:100px;"><img src="{{$blogs->photo}}" alt="promo image"style="max-height: 90px;max-width:120px">
                                          </div>
                                        </div>
                                    </div>
                                
                                    <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Publish At</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" required type="date" value="{{$blogs->publish_at}}" placeholder="Publish At"
                                            id="example-text-input" name="publish_at">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" required name='status' value="{{$blogs->status}}">
                                            <option value="">--Status--</option>
                                            <option value="1" {{ $blogs->status == '1' ? 'selected' : '' }}>Publish</option>
                                            <option value="0" {{ $blogs->status == '0' ? 'selected' : '' }}>Draft</option>
                                        </select>
                                    </div>
                                </div>
                                    <div class="d-flex">
