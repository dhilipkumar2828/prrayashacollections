                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="float-right page-breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('Assign_role_user.index')}}">Assign User Role</a></li>
                                            ...
                                            <td>
                                                <div class="btn-group m-b-10">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item" href="{{route('Assign_role_user.edit',$user->id)}}">Edit</a>
                                                        @endcan
                                                        <form action="{{route('Assign_role_user.destroy',$user->id)}}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                            @can('Assign User Role Delete')
                                                            <a class="dltBtn btn waves-effect waves-light"title="delete" data-id="{{$user->id}}" data-toggle="modal" data-dismiss="modal" data-target=".bs-example-modal-center">Delete</a>
                                                            @endcan
                                                            <br>
                                                        </form>
