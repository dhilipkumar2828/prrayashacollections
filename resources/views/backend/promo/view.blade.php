                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- <td> {{$item->title}}</td> -->
                                    <td> <img src="{{$item->Session_left_1}}" alt="promo image"style="max-height: 90px;max-width:120px"></td>
                                            
                                            <td> <img src="{{$item->Session_right_1}}" alt="promo image"style="max-height: 90px;max-width:120px"></td>
                                            
                                            <td> <img src="{{$item->Session_left_2}}" alt="promo image"style="max-height: 90px;max-width:120px"></td>
                                            
                                            <td> <img src="{{$item->Session_right_2}}" alt="promo image"style="max-height: 90px;max-width:120px"></td>
