                ...
                <div class="col-lg-12">
                    ...
                    <form  class="ltn__form-box contact-form-box pb-50 pt-50" method="POST" style="width: 50%; ">
                           ...
                           <!-- <label for="login_username">Email <sup>*</sup></label> -->
                            <input type="email" id="forget_email" class="form-control mb-3" placeholder="Enter your phone" name="phone">

                            <span class="forget_email_err text-danger" style="display:none;">This  field is required</span>

                            <div class="btn-wrapper mt-30">

                                <button class="theme-btn-1 btn btn-block" type="button" id="submit_email">Submit</button>
