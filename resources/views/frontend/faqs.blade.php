                ...
                <div class="container">
                    <div class="row flex-xl-row-reverse">
                        <div class="col-lg-6 col-xl-7">
                            <div class="faq-thumb">
                                <img src="{{asset('frontend/img/photos/faq-home.webp')}}" width="601" height="368" alt="Image">
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-5">
                            <div class="faq-content">
                                <div class="faq-text-img"><img src="{{asset('frontend/img/photos/faq.webp')}}" width="199" height="169" alt="Image"></div>
                                <h2 class="faq-title">Frequently Asked Questions</h2>
                                <div class="faq-line"></div>
                                <p class="faq-desc">It's tough to establish one all-encompassing template for your About page — there are so many ways you can go about telling your company story. The good news is, there are some tried-and-true steps to get you started.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="accordion" id="FaqAccordion">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="heading3" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>There's no shame in admitting how your business strategy — or even your way of thinking — has changed since you began. In fact, these evolutions can improve the story you tell to website visitors.<br>

                                                About pages are perfect spaces to talk about where you started, how you've grown, and the ideals that have helped your organization mature. Use these moments to further your company story and show people that you're always ready to change and adapt to the needs of your industry.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse7" class="accordion-collapse collapse" aria-labelledby="heading7" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>Got some loyal customers in your portfolio? Use your About page to let the world know who already trusts and benefits from your work. A great way to showcase this is through a case study.<br>

                                                Knowing about your company's past successes can influence your prospects' purchasing decisions because they will be able to envision their success in the success of your past customers.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse8" class="accordion-collapse collapse" aria-labelledby="heading8" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>Customers want to be treated like human beings. For that to happen, they need to feel that they're being served by human beings. When finishing your About page, describe who you are as a person or a team, and what your personal values are. What's your company culture like? What bigger picture in life drives your business?<br>

                                                Keep in mind a secondary audience of your company's About page consists of your future employees. This is another reason describing your personal values is a good idea — the key to your job candidates' hearts is to show them you have one too.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
