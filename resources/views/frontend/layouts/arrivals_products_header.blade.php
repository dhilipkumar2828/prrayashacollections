                 ...
                 <div class="col col-md-4">
                     <div class="header-action justify-content-end">
                         ...
                         <div class="cart_render">
                            ...
                            @php
                            $id=auth()->guard('users')->user()->id;
                            $cart=DB::table('cart_tables')->Join('product_variants','product_variants.id','cart_tables.product_varient')->where('customer_id',$id)->count();
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Track Your Orders with AWB</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                  <span aria-hidden="true">&times;</span>
                                                </button>
                                              </div>
                                              <div class="modal-body">
                                               <a href="https://stcourier.com/track/shipment" target="_blank" class="btn btn-warning"><span>Within Tamilnadu & Pondicherry</span></a><br><br>
                                                <a href="https://www.indiapost.gov.in/_layouts/15/dop.portal.tracking/trackconsignment.aspx" target="_blank" class="btn btn-success  btn-sm">Other Locations</a>
                                              </div>
                         ...
                         <button class="header-menu-btn" t}
                             ...
                             <li>
                                 ...
                                 <div class="dropdown logoutheader">
                                     <a href="{{url('customer/my_account')}}" class="dropbtn"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                        ...
                                        <a href="javascript:;" data-toggle="modal" data-target="#trackModal3" class="dropbtn">
                                             <i class="fa fa-truck fa-2x" aria-hidden="true"></i>
                                         </a>
                                         <div class="modal fade" id="trackModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Track Your Orders with AWB</h5>
                                              ...
                                              <div class="modal-body">
                                               <a href="https://stcourier.com/track/shipment" target="_blank" class="btn btn-warning "><span>Within Tamilnadu & Pondicherry<span></a><br><br>
                                                <a href="https://www.indiapost.gov.in/_layouts/15/dop.portal.tracking/trackconsignment.aspx" target="_blank" class="btn btn-success w-100 btn-sm">Other Locations</a>
                        ...
                        <ul class="main-nav justify-content-center">
                            ...
                            <li class="has-popup">
                               <a  href="{{url('product_list').'/'.$c->slug}}">{{$c->title}}</a>
                                @php
                			    $products=DB::table('products')->where('status','active')->where('header','active')->get();
                	   $subcategory=DB::table('categories')->where('is_parent',1)->where('parent_id',$c->id)->where('header','active')->where('status','active')->get();
							 ...
							 href="{{url('product_list').'/'.$sub->slug}}">{{$sub->title}}</a>
                                            ...
                                            <ul class="subcategroryy-sub-menu">
                                                 @foreach($child_subcategory as $cs)
                                                <li><a class="sub-sub-menu"
							 href="{{url('product_list').'/'.$cs->slug}}">{{$cs->title}}</a></li>
							                    @endforeach
                                            </ul>
                        ...
                        <!----
                         ...
                         <ul class="main-nav justify-content-center">
                             ...
                             <li class="has-submenu  position-static"><a
                                 ...
                                 @php
                                 $products=DB::table('products')->where('status','active')->where('header','active')->get();
                                 $subcategory=DB::table('categories')->where('is_parent','!=',0)->where('parent_id',$c->id)->where('header','active')->get();
                                 ...
                                 <div class="submenu-nav">
                                     <div class="row w-100 p-2">
                                         @foreach($subcategory as $sub)
                                         @php
                                         $child_subcategory=DB::table('categories')->where('is_parent','!=',0)->where('parent_id',$sub->id)->where('header','active')->get();
                                         @endphp
