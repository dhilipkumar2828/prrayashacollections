                                            ...
                                            <div class="sentopt_screen_guest">
                                               ...
                                               <form action="{{route('guestverifyOtp')}}" class="form-horizontal" method="POST">
                                                ...
                                                <div class="form-group mb-6">
                                                    ...
                                                    <input type="text" id="guest_mobile" name="guest_mobile" placeholder="Enter your mobile number" pattern="[0-9]{10}" required >
                                                 ...
                                                 <div class="form-group mb-6">
                                                    ...
                                                    <input type="checkbox" class="form-check-input" id="remember_pwsd">
                                                        ...
                                                        <label class="form-check-label" for="remember_pwsd" id="guest_sendOtpButton">Login with OTP</label>
                                          
                                                </div>
        
                                                <div class="form-group d-flex align-items-center mb-14 flex-column">
                                                <span id="sendotpmessage1" style="display:none;"></span>
                                                <button  type="submit" id="guest_login_submit" class="default-btn w-100 mb-4">Verify OTP</button>
