                                ...
                                <div class="product-reviews-form">
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="form-input-item">
                                            ...
                                            <input class="form-control input" id="phone_number" type="text" placeholder="Mobile Number" required>
...
<input type="hidden" id="product_rating" name="product_rating">
                                        ...
                                        <span id="successmessage" style="display:none;">Reivew Updated Successfully !..</span>
                                        ...
                                        <div class="form-input-item mb-0">
                                            ...
                                            <button type="button" id="review_submit1"

                                                class="btn" onclick="reviewupdate()">Submit</button>
