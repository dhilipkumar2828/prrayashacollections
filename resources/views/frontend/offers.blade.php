                            ...
                            <div class="row align-items-center position-relative">
                                <div class="col-12 col-md-6">
                                    <div class="hero-two-slide-content">
                                        <div class="hero-two-slide-text-img"><img
                                                src="{{asset('frontend/img/slider/text-light.webp')}}" width="427" height="232"
                                                alt="Image"></div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="hero-two-slide-thumb">
                                        <img src="{{asset('frontend/img/slider/banner4.png')}}" width="690" height="690"
                                            alt="Image">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row g-3 g-sm-6">
                    ...
                    <div class="col-4 col-lg-4 col-lg-4 col-xl-4 mt-xl-0 mt-sm-4 mt-4">
                        ...
                        <a href="#" class="product-category-item offer-deal">
                            <img class="icon deal-icon" src="{{asset('frontend/img/shop/category/6.webp')}}" width="80" height="80"
                                alt="Image-HasTech">
                    ...
                    <div class="col-4 col-lg-4 col-lg-4 col-xl-4  mt-xl-0 mt-sm-4 mt-4">
                        ...
                        <a href="#" class="product-category-item offer-deal" data-bg-color="#FFF3DA">
                            <img class="icon deal-icon-1" src="{{asset('frontend/img/shop/category/1.webp')}}" width="70" height="80"
                                alt="Image-HasTech">
                    ...
                    <div class="col-4 col-lg-4 col-lg-4 col-xl-4 mt-xl-0 mt-sm-4 mt-4">
                        <!--== Start Product Category Item ==-->
                        <a href="#" class="product-category-item offer-deal">
                            <img class="icon deal-icon" src="{{asset('frontend/img/shop/category/4.webp')}}" width="80" height="80"
                                alt="Image-HasTech">
                ...
                <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
                        ...
                        <div class="product-item product-st3-item">
                            <div class="product-thumb">
                                <a class="d-block" href="product-details.html">
                                    <img src="{{asset('frontend/img/shop/product-1-removebg-preview.png')}}" width="370"
                    ...
                    <div class="col-6 col-lg-4 col-xl-3 mb-4 mb-sm-8">
                        ...
                        <div class="product-item product-st3-item">
                            <div class="product-thumb">
                                <a class="d-block" href="product-details.html">
                                    <img src="{{asset('frontend/img/shop/product-2-removebg-preview.png')}}" width="370"
                                        height="450" alt="Image-HasTech">
                                </a>
                    ...
                    <div class="col-6 col-lg-4 col-xl-3 mb-4 mb-sm-8">
                        ...
                        <div class="product-item product-st3-item">
                            <div class="product-thumb">
                                <a class="d-block" href="product-details.html">
                                    <img src="{{asset('frontend/img/shop/product-3-removebg-preview.png')}}" width="370"
                                        height="450" alt="Image-HasTech">
                                </a>
                                <span class="flag-new">20%</span>
                                <div class="product-action">
