                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="invoice-title">
                                ...
                                <h3 class="m-t-0">
                                    <img src="{{asset('frontend/img/logo.png')}}" style="height: 100px;" alt="logo"  />
                                </h3>
                            </div>
                            <hr>
                            <?php
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{$datas->amount*$datas->quantity}}</td>
                                                </tr>
                                                @endforeach
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-line text-right">
                                                    <h4 class="m-0">₹{{($order->sub_total + $delivery_charge)-$order->discound_amount}}</h4>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
