...
gap: 5%; /* Set a gap of 5% between items */
}
.tab {
    float: left;
...
height: auto; /* This will let the content define the height */
min-height: 100px; /* Optional: You can set a minimum height if needed */
...
.category-item {
    flex: 0 0 auto;
    margin-right: 0; /* Add some space between items */
}
...
text-align: center;
max-width: 150px; /* Constrain the width to match the image */
margin: 0 auto; /* Center-align title below the image */
}
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.lazyload/1.9.1/jquery.lazyload.min.js" integrity="sha512-jNDtFf7qgU0eH/+Z42FG4fw3w7DM/9zbgNPe3wfJlCylVDTT3IgKW5r92Vy9IHa6U50vyMz5gRByIu4YIXFtaQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <?php
      ...
      <!--</div>-->
       <div class="offer mob">
    <p>FLAT ₹{{$flatoffers->flatofferamount}} OFF /  Flat ₹{{$flatoffers->flatofferamount}} Off on Orders above ₹{{$flatoffers->offeramountabove}}\</p>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            ...
            <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="{{$i}}"
                class="@if($i == 0) active @endif" aria-current="true" aria-label="Slide {{$i}}"></button>
            @endforeach
        </div>
        ...
        <div class="carousel-inner">
            @foreach($banners as $i=>$b)
            @if($b->link != '0')
            <a href="product_list/{{$b->link}}" class="carousel-item @if($i == 0) active @endif"
...
<section class="hero-two-slider-area position-relative1 d-block d-md-none">
    ...
    <div id="carouselExampleCaptions11" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            @else
            <div class="carousel-item @if($i == 0) active @endif"
                style="background:url('{{asset($b->mobile_photo)}}') no-repeat;height: 315px !important;"></div>
            @endif
            @endforeach
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="custom-title text-left">
                    <h3 class="title fontsiz mt-5 mb-3">Favourite Collections<span class="headingline"></span></h3>
                </div>
            </div>
        </div>
...
@foreach($browseCategories as $categoryList)
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                    ...
                    <a href="{{url('product_list').'/'.$categoryList->link}}">
                        <img src="{{ $categoryList->photo }}" alt="{{ $categoryList->title }}" style="object-fit: cover;border-radius: 1PX;"
                        class="img-fluid">                        
...
@endif
  ...
  <div class="container">
    <div class="row">
        <div class="col-12">
        <div class="custom-title text-left" style="display: flex; justify-content: space-between; align-items: center;">
                <h3 class="title fontsiz mt-5 mb-3">New Arrivals <span class="headingline"></span></h3>
                <a class="btn" href="{{url('/newarrival_list')}}" style="margin-left: 20px; background-color: #080a54; color: #fff; border-radius: 5px; text-decoration: none;">
                View All
                </a>
                </div>
        </div>
                            ...
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="price-info">
                                        @if($product->discount > 0)
                                            <div class="product-price">
                                                <div class="discounted-price">
                                                    <span><i style="font-size:14px" class="fa">&#xf156;</i>{{ $price }}</span>
                                                </div>
                                                <div class="original-price">
                                                    <span><i style="font-size:14px" class="fa">&#xf156;</i>{{ $newsizevariant1->regular_price }}</span>
                                                </div>
                                        ...
                                        @else
                                            <p class="product-price"><i style="font-size:14px" class="fa">&#xf156;</i>{{ $newsizevariant1->regular_price }}</p>
                                        @endif
                                    </div>
                                        ...
                                        @foreach($variants_array as $vals)
                                            <div class="size-buttons-tipAndBtnContainer">
                                                <div class="size-buttons-buttonContainer">
                                                    <button class="size-buttons-size-button{{ $vals->in_stock > 0 ? '' : '-disabled' }} size-buttons-size-button-default"
    ...
    <div class="container-fluid catelistslider">
        ...
        @foreach($category as $c)
            ...
            @if($subcategory->count() > 0)
                <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
                    <div class="custom-title text-left">
                        <h5 class="title fontsiz" style="margin-top: 5px; margin-bottom: 2px;">{{ $c->title }}</h5>
                    </div>
                            ...
                            <div class="item">
                                <div class="category-item text-center">
                                    <a href="{{ url('product_list').'/'.$sub->slug }}">
                                        <img src="{{ $sub->photo }}" class="img-fluid" alt="" style="height: 70px; width: 70px;">
...
<section class="browse-list-section webcategorylist">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="tab">
                @foreach($category as $c)
                    <button class="category-button" data-category-id="{{ $c->id }}">{{ $c->title }}</button>
                @endforeach
            </div>
...
@if( !empty($advertisement->photo))
        ...
        <div class="row">
                <div class="col-12">
                    <div class="custom-title text-left">
                        <h3 class="title fontsiz mt-1 mb-3">Prrayasha Styles <span class="headingline"></span></h3>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <img src="{{ !empty($advertisement->photo) ? $advertisement->photo : '' }}" alt="{{ $advertisement->photo }}" style="margin: 1px; border-radius: 22px;">
                ...
                @if(!empty($categoryList->photo))
                    ...
                    <div class="item">
                        ...
                        <div class="category-item text-center">
                            ...
                            <img src="{{ $categoryList->photo }}" alt="{{ $categoryList->title }}" style="width: 300px; height: 200px; object-fit: cover;border-radius: 15PX;" class="img-fluid mb-3">
                            <h5 class="title fontsiz mt-0 mb-0">{{ $categoryList->title }}</h5>
 ...
 <section class="browse-list-section">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <div class="custom-title text-left">
                    <h3 class="title fontsiz mt-5 mb-3">Product From Prrayasha<span class="headingline"></span></h3>
                </div>
            </div>
        </div>
...
@foreach($browseCategories as $categoryList)
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                    <div class="category-item text-center">
                    <a href="{{url('product_list').'/'.$categoryList->link}}">
                        <img src="{{ $categoryList->photo }}" alt="{{ $categoryList->title }}" style=object-fit: cover;border-radius: 1PX;" class="img-fluid mb-3">                        
            ...
            <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
                ...
                @if(!empty($offers->photo))
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                        ...
                        <img src="{{ asset($offers->photo) }}" alt="{{ $offers->title }}" style="width: 300px; height: 300px; object-fit: cover;border-radius: 15PX;" class="img-fluid mb-3">
   ...
   <div class="parallax-section parallax1">
    ...
    <section id="testimonials">
        ...
        <div class="testimonial-heading">
                <p>Client Says</p>
<a href="{{url('reviews')}}"> <h6 style="color:#364958"> Write your Reviews
        <i class="fa fa-pencil"></i>
         </h6></a>
         
         <a href="https://www.google.com/search?sca_esv=147d6c4ab23ffdc0&sxsrf=AE3TifPQMfP0WMokcx9i9Zup3fAAzWwC-w:1765615927101&si=AMgyJEtREmoPL4P1I5IDCfuA8gybfVI2d5Uj7QMwYCZHKDZ-E3-oGmbeJkEHA--oJ416_kTOU_BeDzzMmFAPb_9f7n8OVTiBaMJksBgcrCcb5yskQEFOMZ1oyF1Xl39VNUYM7IWMui7WAZpyrf7tMKeVg5sAW9MR1Q%3D%3D&q=Prrayasha+Collections+Reviews&sa=X&ved=2ahUKEwie45Pxl7qRAxXxTmwGHbjpCAwQ0bkNegQIOhAD&biw=1536&bih=695&dpr=1.25" target="_blank" rel="noopener">
  <button class="google-review-btn">
    ⭐ View Google Reviews
  </button>
</a>
        ...
        <div class="row featuredlist mb-n4 mb-sm-n10 g-3 g-sm-6">
            ...
            @if(!empty($youtube->photo))
                <div class="col-lg-3 col-md-6 col-sm-6 mb-3">
                        ...
                        <img src="{{ asset($youtube->photo) }}" loading="lazy" alt="{{ $youtube->photo }}" style="border-radius: 15PX;"  class="img-fluid">
    ...
    <!--== scroll bg ==-->
        ...
        <section class="instagram-area pt-100 d-none">
            ...
            <!-- insta repeat -->
                ...
                <img src="https://kiruthika.oceansoftwares.in/krishna/1/assets/img/products/316136008_2394655777350955_7616695352540162676_n.jpg" />
                ...
                <img src="https://kiruthika.oceansoftwares.in/krishna/1/assets/img/products/316120734_1331499004347094_1570003295056820631_n.jpg" />
                ...
                <img src="https://kiruthika.oceansoftwares.in/krishna/1/assets/img/products/316180237_1095068017863297_3278486297116119573_n.jpg" />
                    ...
                    <div class="modal-body" id="para-text">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="subscriber_email" placeholder="Email Address">
   ...
   <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="banner-box-footer">
                ...
                <img src="{{ !empty($advertisement2->photo) ? $advertisement2->photo : '' }}" alt="{{ $advertisement2->photo }}">
        ...
        <div class="container">
            ...
            <div class="col-md-4 col-sm-4 mb-3">
                    <div class="category-item benefits text-center">
                         ...
                         <h5 class="title fontsiz benefits mt-0 mb-0">    <i class="fa fa-heart" aria-hidden="true"></i> Budget Friendly</h5>
                    ...
                    <div class="category-item benefits text-center">
                         ...
                         <h5 class="title fontsiz benefits mt-0 mb-0"><i class="fa fa-truck" aria-hidden="true"></i> Free Shipping</h5>
             ...
             <div class="col-md-4 col-sm-4 mb-3">
                    ...
                    <div class="category-item benefits text-center">
                           ...
                           <h5 class="title fontsiz benefits mt-0 mb-0"><i class="fa fa-shield" aria-hidden="true"></i> 100% ORIGINAL</h5>
       ...
       <section class="browse-list-section mobenifit">
        ...
        <div class="container">
            ...
            <div class="benefitrow ">
                        ...
                        <div class="category-item benefits text-center">
                            <a href="https://www.instagram.com/prrayashacollections/" target="_blank">
                        <img src="public/frontend/img/insta.webp" style="padding:10px; width: 150px;">
                        </a>
                        ...
                        <div class="category-item benefits text-center">
                            <a href="https://www.facebook.com/people/Prrayasha-Collections/61554943980619/" target="_blank">
                        <img src="public/frontend/img/fb.webp" style="padding:10px; width: 150px;">
                        </a>
                        ...
                        <div class="category-item benefits text-center">
                        <a href="https://www.youtube.com/@prrayashacollections" target="_blank">
                        <img src="public/frontend/img/yt.png" style="padding:10px; width: 150px;">
                        </a>
