...
<main class="main-content">
    ...
    <section class="hero-two-slider-area position-relative ">
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                if($b->link!='0'){
                    ?>
                    <a href="product_list/{{$b->link}}" class="carousel-item @if($i == 0) active @endif" style="background:url('{{asset($b->photo)}}') no-repeat;"></a>
                <?php 
                }else{
                    ?>
                    <div class="carousel-item @if($i == 0) active @endif" style="background:url('{{asset($b->photo)}}') no-repeat;"></div>
                <?php 
                }
                ?>
    ...
    ?>
     ...
     <!-- </div>-->
      ...
      <div class="offer mob">
    <p>FLAT ₹{{$flatoffers->flatofferamount}} OFF /  Flat ₹{{$flatoffers->flatofferamount}} Off on Orders above ₹{{$flatoffers->offeramountabove}}\- Use Code: {{$flatoffers-> coupon_code}} </p>
    </div> 
  </div>
    <?php } ?>
            ...
            @if(!empty($categoryList->photo))
                ...
                <div class="item">
                    ...
                    <div class="category-item text-center">
                        ...
                        <img src="{{ $categoryList->photo }}" alt="{{ $categoryList->title }}" loading="lazy" style="width: 300px; height: 200px; object-fit: cover;border-radius: 15PX;" class="img-fluid mb-3">
...
<section class="top-product-list-section  mb-5">
    ...
    if ($newsizevariant1) {
        if ($product->discount_type == "fixed") {
            ...
            if ($newsizevariant1->regular_price != 0 && $newsizevariant1->regular_price != 'null') {
    ...
    $aSaleprice = Helper::fetchSalePrice($newsizevariant1 ? $newsizevariant1->regular_price : 0, $product->tax_id, $product->discount, $product->discount_type);
@endphp
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-4 text-center">
                ...
                @if($product->discount > 0)
                    <div class="product-price">
                        ...
                        <div class="product-discount"><p>{{ $product->discount }}{{$discount}} Off</p></div>
                    </div>
                @else
            ...
            ?>
              @if(count($newsizevariant)==0)
                                <div class="outofstock single home" style="border: 1px solid #222e64;background: #222e64;color: #fff;width:100%;">
                                    <p>Out Of Stock</p>
                                </div>
                                 @endif
                    ...
                    <div class="size-buttons-size-buttons">
                        ...
                        <div class="size-buttons-tipAndBtnContainer">
                            <div class="size-buttons-buttonContainer"><button
                                    class="size-buttons-size-button<?php echo $class; ?> size-buttons-size-button-default" data-product-stock="{{$vals->in_stock}} Stocks Available" data-tippy-content="{{$vals->in_stock}} Stocks Available"><span
        ...
        <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
            ...
            @if(!empty($offers->photo))
                <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                    ...
                    <img src="{{ asset($offers->photo) }}" loading="lazy" alt="{{ $offers->title }}" style="width: 300px; height: 300px; object-fit: cover;border-radius: 15PX;" class="img-fluid mb-3">
...
<div class="parallax-section parallax1">
    ...
    <section id="testimonials">
        ...
        <p>Client Says</p>
          ...
          <a href="{{url('reviews')}}"> <h6 style="color:white"> Write your Reviews
            ...
            @if(!empty($youtube->photo))
                <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                    <div class="category-item text-center">
                        ...
                        <img src="{{ asset($youtube->photo) }}" loading="lazy" alt="{{ $youtube->photo }}" style="width: 300px; height: 200px; object-fit: cover;border-radius: 15PX;"  class="img-fluid mb-3">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="banner-box-footer">
                ...
                <img src="{{!empty($advertisement->photo) ? $advertisement->photo : ''}}" loading="lazy" alt="">
