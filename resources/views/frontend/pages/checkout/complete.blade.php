...
<div class="container-fluid banner">
	<figure id="banner-figure"><a href="#"><img src="{{$data->photo}}" class="img-responsive" alt="img-holiwood" style="width: 100%"></a></figure>
	<div class="title-banner">
		<h1 style="color:black !important">Order Completed</h1>
		<p style="color:black !important"><a href="{{route('index')}}" title="Home" style="color:black !important">Home</a><i class="fa fa-caret-right"></i>Order Completed</p>
	</div>
</div>
@endforeach
<div class="container container-ver2 space-padding-tb-30">
            ...
            <div class="container container-ver2">
                <div class="box float-left order-complete center space-50">
                    ...
                    <div class="box">
                        <a class="link-v1 lh-50 margin-right-20 space-20 color-brand" href="{{route('index')}}" title="HOME PAGE">HOME PAGE</a>
                        <a class="link-v1 lh-50 margin-right-20 space-20 color-brand" href="{{route('whatisnew')}}" title="CONTINUS SHOPPING">CONTINUS SHOPPING</a>
                    </div>
                </div>
            </div>
            <!-- End container -->
