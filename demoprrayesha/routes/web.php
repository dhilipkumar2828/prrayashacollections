...
Route::get('test/login', [App\Http\Controllers\Frontend\IndexController::class, 'testlogin'])->name('test.login');
Route::get('test/createaccount', [App\Http\Controllers\Frontend\IndexController::class, 'testcreateaccount'])->name('test.createaccount');
Route::get('test/guestlogin', [App\Http\Controllers\Frontend\IndexController::class, 'testguestlogin'])->name('test.guestlogin');
...
//Filemanager
Route::group(['prefix' => 'filemanager', 'middleware' => ['web', 'auth:web']], function () {
     \UniSharp\LaravelFilemanager\Lfm::routes();
 });
...
Route::get('/{id}', [\App\Http\Controllers\Frontend\WhatisnewController::class, 'order_pdf']);
