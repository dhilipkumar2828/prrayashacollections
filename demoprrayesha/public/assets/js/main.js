    ...
    for (let k2 = 0; k2 < ($('#chil_cat_id3').val().length); k2++) {
        ...
        if (variant.indexOf(vid) == -1) {
            ...
            let details = '<div class="card border1" id="vchild' + vid +
                ...
                '<input type="text"  class="form-control required2 add_varianterrsku add_varianterrsku'+vid+'" name="sku[]"  placeholder="SKU" style="width:100%;" required>' +
                ...
                '</div>' +
                '</div>' +
                '<div class="col-md-6 ml-6" style="padding: 0px 35px;">' +
                 '<div class="form-group">' +
                 '<p>Product Colors</p>' +
                ...
                '<input type="text"  class="form-control required2 add_varianterrstock add_varianterrstock'+vid+'" name="stock[]" placeholder="Stock" style="width:100%;" required>' +
                '<div class="err_emptyval" style="color:red;display:none">This field is required</div>'+
                '<span class="error"></span>'+
                '</div>' +
                '</div>' +
