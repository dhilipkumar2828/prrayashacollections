...
.size-buttons-size-button {
    padding: 10px 20px; /* Increase padding for larger touch target */
...
<section class="browse-list-section mobviewsecone">
    ...
    @php $reviewval=DB::table('product_reviews')->where('status','accept')->where('product_id',$product->id)->get();
        ...
        <div class="container">
            ...
            <div class="row product-details">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="product-left ">
        				...
        				<div class="swiper-container product-slider my-0">
        				...
        				<div class="swiper-container product-thumbs" style="z-index:0">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="product-details-content">
                        ...
                        <h3 class="product-details-title mb-0">{{$product->name}}</h3>

                        <div class="product-details-action d-block mb-0">
                            <?php 
                        $newsales_price='';
                        ...
                        ?>
                            <h4 class="price">
                                ...
                                <span>₹</span><span
                                    ...
                                    class="product_rate_{{$product->product_id}}">{{ number_format($price,2,'.','')}}</span>
                                 @if($ADiscountpercent !=0)
                                    <span class="price-old">
                                        <span class="price"><span>₹</span> <span id="newdeprice">{{ number_format($newsizevariant1->regular_price,2,'.','') }}</span></span>
                                  @endif
                    ...
                    <!--    <div class="product-rating">
                            ...
                            <label class="rating-label d-flex align-items-center">
                                ...
                                <div class="outofstock" style="position: static;padding: 0px 31px;border: 1px solid #222e64;background: #222e64;color: #fff;width:31%;">
                                    <p>Out Of Stock</p>
                                </div>
                                 @endif
                        ...
                        <a  href="#product-description" style="color: #0f57af">Read More</a>
                        ...
                        ?>
                         ...
                         <input type="hidden" id="product_varients_id" name="product_varients_id" value="{{$p124}}">
                                                ...
                                                ?>
                                                 <div class="size-buttons-tipAndBtnContainer">
                                                    <div class="size-buttons-buttonContainer">
                                                        <button  class="size-buttons-size-button size-buttons-size-button-default product-variant-size-button" data-tippy-content="{{$vals->in_stock}} Stocks Available" data-product-stock="{{$vals->in_stock}} Stocks Available" data-product-variant-size="<?php echo $vals->variants ?>" onclick="productsizechange('<?php echo $vals->variants ?>')">
                        ...
                        <span id="product_size_message" style="color:red;font-weight:bold;display:none;">Please Select Size</span>
                        ...
                        @endif
                        @if($product->stock>0)
                        <div class="product-details-pro-qty mt-4 d-flex align-items-center">
                           
                            <div class="pro-qty">

                                         <input type="hidden" id="count_prod_qty{{$product->id}}" class="count_prod_qty"
              ...
              <input type="text" id="quantity{{$product->id}}" title="Quantity"
                                    ...
                                    value="{{$cart_qty}}" style=" width: 110px;padding: 8px;border: 1px solid #ccc; border-radius: 4px;font-size: 16px;" readonly>

                            <div class="dec qty-btn single_product_render_count" data-product_id="{{$product->id}}" data-type="dec">-</div>

                            <div class="inc qty-btn single_product_render_count"  data-product_id="{{$product->id}}" data-type="inc">+</div>
                            ...
                            <button type="button"
                                ...
                                class="addbtn add_to_cartid add_tocart_modal"

                                data-product_id="{{$product->id}}"  style="white-space: nowrap;" data-type="multi_cart">Add to cart</button>
                            @endif
                              

                            <button type="button"

                                class="product-action-btn action-btn-wishlist wishlist_save4 icon_{{$product->id}} add_towishlist_modal btn-wishlist"  style="white-space: nowrap;"
            ...
            <div class="row tabs-main mt-4" id="product-description">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="nav product-info-tabs nav-pills" id="myTab" role="tablist">
                   ...
                   <!--     <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content mt-1" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="ptabs2" role="tabpanel" aria-labelledby="product-tab2">                  <h5>Product Benefits</h5>

                            <p>{!!html_entity_decode($product->benefits) !!}</p>

                        </div>

                        <div class="tab-pane fade" id="ptabs3" role="tabpanel" aria-labelledby="product-tab3">                 <h5>Product Usage</h5>

                            <p>{!!html_entity_decode($product->usage) !!}</p>

                        </div>

                        <div class="tab-pane fade" id="ptabs4" role="tabpanel" aria-labelledby="product-tab4">                 <h5>Product Ingrediants</h5>
                                ...
                                <div class="product-reviews-form">
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="form-input-item">
                                            ...
                                            <textarea class="form-control textarea" id="review_comment"

                                                placeholder="Enter you feedback" required></textarea>
                                        ...
                                        <div class="form-input-item">
                                            ...
                                            <input class="form-control input" id="review_customername" type="text" placeholder="Full Name" required>
                                        ...
                                        <div class="form-input-item">
                                            ...
                                            <input class="form-control input" id="review_customerphone" type="text" placeholder="Mobile Number" required>
                                        ...
                                        <div class="form-input-item">
                                            ...
                                            <input class="form-control input" id="review_customeremail" type="email"
                                     ...
                                     <div id="invalidemail_err" class="text-danger"
                                                ...
                                                style="font-family:auto;display:none">Invalid email address</div>
...
<input type="hidden" id="product_rating" name="product_rating">
                                        ...
                                        <div class="alert alert-success" style="display:none" id="success_review">Review
                                        ...
                                        <div class="form-input-item mb-0">
                                            ...
                                            <button type="button" id="review_submit"
                                                ...
                                                data-product_id="{{$product->id}}" class="btn">Submit</button>
        ...
        <div class="container">
            ...
            @foreach($r_Products as $key=>$product)
                 ...
                 @php $rela_val=0; @endphp
                    ...
                    @php $relatedreviewval=DB::table('product_reviews')->where('product_id',$product->id)->get();
                 ...
                 <?php 
                    $variant=\App\Models\ProductVariant::where('product_id',$product->id)->where('status','active')->first();
                       ...
                       $variants_array = \App\Models\ProductVariant::where('product_id', $product->id)
                        ...
                        $newsize = array(); // Initialize the array outside the loop
                        ...
                        <div class="product-item single-productsBox">
                            ...
                            <div class="product-thumb  product-image">
                                ...
                                <a class="d-block" href="{{url('products').'/'.$product->slug}}">
                                    ...
                                    <img src="{{asset($r_Productvariant_photo[$key])}}" alt="Image-HasTech" class="home_product_img product-first-image">

                                    <img src="{{asset($ahover_image_photo[$key])}}" class="product-hover-image" alt="image">
                                ...
                                <div class="product-action">
                                    ...
                                    <button type="button" data-product_id="{{$product->id}}"
                                        ...
                                        class="product-action-btn action-btn-wishlist wishlist_save8 icon_{{$product->id}} add_towishlist_modal"
                                        ...
                                        <!--    <div class="product-rating text-center justify-content-center">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <span
                                                    ...
                                                    class="price-old"> {{ $variant->regular_price }}</span>
                                                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="size-buttons-size-buttons">
                        <?php
                          ...
                          ?>
                        <div class="size-buttons-tipAndBtnContainer" style="margin: 10px 6px 10px 0;">
                            <div class="size-buttons-buttonContainer"><button
                                    class="size-buttons-size-button<?php echo $class; ?> size-buttons-size-button-default" style="min-width:30px; height:30px"><span
                                        class="size-buttons-size-strike-hide"></span>
                                    <p class="size-buttons-unified-size" style="font-size:9px;">{{$vals->variants}}</p>
                                </button></div>
    ...
    $.ajax({
          ...
          success:function(response){
             ...
             if(response!=''){
                 ...
                 $(".product_rate_").html(response.data.regular_price);
