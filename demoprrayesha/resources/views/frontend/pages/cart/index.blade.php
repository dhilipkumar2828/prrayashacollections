                    ...
                    <div class="coupon-accordion" id="CouponAccordion">
                            <div class="card">
                                <h3 style="font-size:16px;">
                                    ...
                                    <a href="#/" data-bs-toggle="collapse" data-bs-target="#couponaccordion" >Click here to enter your coupon code</a>
                                </h3>
                                            ...
                                            <form action="#" method="post" id="checkout_form">
                                                <div class="row">
                                                    ...
                                                    @if(count(Session::get('coupon',[])) >0)
                                                        ...
                                                        @else
                                                        <div class="col-md-6">
                                                             <input type="hidden" name="coupontotal" id="coupantotal" value="{{$sub_amt}}">
