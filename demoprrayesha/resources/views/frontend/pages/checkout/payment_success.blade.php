...
<main class="main-content">
    <div class="container" style="margin-top:5%; margin-bottom:5%; box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px; padding: 10px">
	...
	<div class="row">
        ...
        <div class="jumbotron">
          ...
          <p class="text-center "><b>Your order id is: <span style="color:#6DA93E">{{$order_id}}</span></b></p>

          <p class="text-center h6 mb-3"><b>Amount: ₹{{$amount}}</b></p>



            <center><div class="btn-group" style="margin-bottom:50px;">
