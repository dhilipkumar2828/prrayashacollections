                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="f_name" class="mb-1">First name <span class="required" title="required">*</span></label>
                                                    <input id="f_name" type="text" class="form-control" value={{($shipping_address) ? $shipping_address->sfirst_name : '';}}>
                                                    <div id="fn_err" class="f_nameerr text-danger" style="display:none;">This field is required</div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="l_name"  type="text" class="form-control" value={{($shipping_address) ? $shipping_address->slast_name : '';}}>
                                                 
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group" class="mb-1">
                                                    <label for="phone">Phone Number <span class="required" title="required">*</span></label>
                                                    <input id="phone" name="phone" minlength="10" maxlength="10"  onkeypress="return isNumber(event)" type="text" class="form-control" required value={{($shipping_address) ? $shipping_address->sphone_number : '';}}>
                                                    <div id="phone_err" class="phoneerr text-danger" style="display:none;">This field is required</div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="street-address" class="mb-1">Address <span class="required" title="required">*</span></label>
                                                    <input id="street-address" type="text" class="form-control" placeholder="House number and street name" value="{{($shipping_address) ? $shipping_address->sstreet_1 : '';}}">
                                                    <div id="street1_err" class="addresserr text-danger" style="display:none;">This field is required</div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="street-address2" class="visually-hidden mb-1">Street address 2 <span class="required" title="required" value="{{($shipping_address) ? $shipping_address->sstreet_2 : '';}}">*</span></label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="town" class="mb-1">Town / City <span class="required" title="required">*</span></label>
                                                    <input id="town" type="text" class="form-control" value={{($shipping_address) ? $shipping_address->scity : '';}}>
                                                    <div id="city_err" class="cityerr text-danger" style="display:none;">This field is required</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="state" id="state" class="form-control wide" onchange="productgstchange()" required>
                                                        <option value="">Select State</option>
                                                        @foreach($states as $id => $state)
                                                            <option value="{{ $id }}">{{ $state }}</option>
                                                        @endforeach
                                                    </select>
                                                         <div id="city_err" class="stateerr text-danger" style="display:none;">This field is required</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="pin-code" type="text" name="pincode" class="form-control" onkeypress="return isNumber(event)" value={{($shipping_address) ? $shipping_address->spincode : '';}}>
                                                    <div id="pincode_err" class="pincodeerr text-danger" style="display:none;">This field is required</div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-md-12">
                                                <div class="form-group">
                                            ...
                                            <div id="CheckoutBillingAccordion2" class="col-md-12">
                                                ...
                                                <h2 class="title mt-0">Shipping Address</h2>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="sf_name" class="mb-1">First name <span class="required" title="required">*</span></label>
                                                                <input id="sfirst_name" type="text" class="form-control">
                                                                 <div id="pincode_err" class="sf_nameerr text-danger" style="display:none;">This field is required</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                ...
                                                <div class="form-group" class="mb-1">
                                                    <label for="phone">Phone Number  <span class="required" title="required">*</span></label>
                                                    <input id="s-phone" minlength="10" maxlength="10" onkeypress="return isNumber(event)" type="text" class="form-control" required>
                                                    <div id="phone_err" class="checkout_err"></div>
                                                     <div id="pincode_err" class="s_phoneerr text-danger" style="display:none;">This field is required</div>
                                                </div>
                                            </div>
                                                        <!-- <div class="col-md-12 mb-4">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="street-address2-3" class="mb-1">Address <span class="required" title="required">*</span></label>
                                                                <input id="s-address" type="text" class="form-control" placeholder="House number and street name">
                                                         <div id="pincode_err" class="s_addresserr text-danger" style="display:none;">This field is required</div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="street-address2-2" class="visually-hidden mb-1">Address 2 <span class="required" title="required">*</span></label>
                                                                <input id="s-address2" type="text" class="form-control" placeholder="Apartment, suite, unit etc. (optional)">
                                                            <div id="pincode_err" class="pincodeerr text-danger" style="display:none;">This field is required</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="town3" class="mb-1">Town / City <span class="required" title="required">*</span></label>
                                                                <input id="stown" type="text" class="form-control">
                                                             <div id="pincode_err" class="s_cityerr text-danger" style="display:none;">This field is required</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                            <div class="form-group">
                                                                <label for="inputfState" class=" control-label d-block mb-1">State <span
                                                        class="color">*</span></label>
                                                    <select name="state" id="sstate" class="form-control wide">
                                                        @foreach($states as $id => $state )
                                                            @if($id=='31') {{$selected='selected'}} @else {{$selected=''}} @endif
                                                            <option {{ $selected }} value="{{ $id }}">{{ $state }}</option>
                                                        @endforeach
                                                    </select>
                                                              <div id="pincode_err" class="s_stateerr text-danger" style="display:none;">This field is required</div>
                                                                
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="pz-code2" class="mb-1">Postcode / ZIP (optional)</label>
                                                                <input id="spin-code" type="text" class="form-control"  onkeypress="return isNumber(event)">
                                                           <div id="pincode_err" class="s_pincodeerr text-danger" style="display:none;">This field is required</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="shop-payment-method">
                                        ...
                                        <div class="payment-container">
                                            ...
                                            <div class="payment-option">
                                                <input type="radio" id="option2" name="payment-method" class="radio payment_mode" data-mode="Phonepe" aria-expanded="false" value="Phonepe" checked>
                                                <label for="option2">
                                                    <div class="payment-detail">
                                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcgm4pm5jK3vp0VK7ZLLcH3UNY8l11hMWr2Q&s" alt="Visa">
                                                    <div class="payment-detail-desc">
                                                        <span>Cards, UPI, Wallets,</span>
                                                        <span>Paypal, Netbanking</span>
                                                    </div>
                                                    </div>
                                                    <div class="icons">
                                                        <img src="{{ asset('frontend/img/payment_cards/visa.png') }}" alt="Visa">
                                                        <img src="{{ asset('frontend/img/payment_cards/mastercard.png') }}" alt="MasterCard">
                                                        <img src="{{ asset('frontend/img/payment_cards/amex.png') }}" alt="Amex">
                                                        <img src="{{ asset('frontend/img/payment_cards/rupay.png') }}" alt="Discover">
                                                        <span style="color:grey">and more...</span>
                                                    </div>
                                                </label>
                                            </div>
                                            ...
                                            <div class="payment-option" style="display:none;">
                                                <input type="radio" id="option1" name="payment-method" class="radio payment_mode" data-mode="razorPay" data-bs-toggle="collapse" data-bs-target="#itemFive" aria-controls="itemFive" aria-expanded="false" value="Razor Pay">
                                                <label for="option1">
                                                    <div class="payment-detail">
                                                    <img src="{{ asset('frontend/img/payment_cards/razorpay.png') }}" alt="Visa">
                                                    <div class="payment-detail-desc">
                                                        <span>Cards, UPI, Wallets,</span>
                                                        <span>Paypal, Netbanking</span>
                                                    </div>
                                        ...
                                        <p class="p-text">Your personal data will be used to process your order, support your experience throughout this website, and for other purposes described in our <a href="{{url('privacypolicy')}}">privacy policy.</a></p>
                                        <div class="agree-policy mb-4">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="privacy" class="custom-control-input visually-hidden" checked>
                                                ...
                                                <div id="err_terms_conditions" class="err_terms_conditions text-danger" style="display:none;">Please check the policy</div>
                                            </div>
                                        </div>
                                        <button type="button" class="default-btn w-100 proceed_to_checkout" id="place_order3">Place order</button>
