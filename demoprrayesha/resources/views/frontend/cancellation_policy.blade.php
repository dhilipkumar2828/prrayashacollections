            ...
            <section class="">
                <div class="container">
                    ...
                    <div class="policy-list-1">
                       ...
                       <li class="page-header-title">In such cases, the order will be cancelled and the money will be refunded to you within 24-48
                            business hours after the cancellation request. </li>
                    </div>
                    <div class="policy-list-1">
                        <h5>Cancellation post shipment:</h5>
                        <li class="page-header-title">If you wish to cancel an order that has been shipped but has not yet been delivered, please get in
                        ...
                        <li>For payments done through credit/debit cards or net banking, the refund will be processed to the
                            ...
                            products back. It may take 2-3 additional business days for the amount to reflect in your account.</li>
                        <li>For cash on delivery transactions, we will initiate a bank transfer against the refund amount for the
                    ...
                    <div class="policy-list-1">
                       ...
                       <li class="page-header-title">Tulia offers its customers an ‘Easy return policy, wherein you can raise a return/exchange         request for a product within 5 days of its delivery. We also accept partial returns wherein you can raise a return
                       ...
                       <p>Step 3: We will pick up the products within 2-4 business days. We will initiate the refund or
                        ...
                        <li class="page-header-title">Note: If it is a case of replacement, it is subject to the availability of stock. In cases when a
                    ...
                    <div class="policy-list-1">
                       ...
                       <li class="page-header-title">Returned without original packaging including price tags, labels, original packing, freebies, and  other accessories, or if the original packaging is damaged. </li>
                       <li class="page-header-title">The serial number has tampered. </li>
                       <li class="page-header-title">Defective products that are covered under Seller/Manufacturer’s warranty. </li>
                    ...
                    <div class="policy-list-1">
                       ...
                       <li class="page-header-title">Innovative Products cannot be returned since they are available during select promotions and
                        ordered on demand. </li>
                       <li class="page-header-title">Personal care appliances cannot be returned due to hygiene issues. </li>
                       <li class="page-header-title">Please note: For certain marketing campaigns or mega sale periods, special return/exchange/refund
                        rules may apply. Information regarding this is visible on the promotion banner. For any clarification, please feel free to contact our customer care.</li>
                       <h5>I have received a damaged or defective item/wrong product in my order, how should I proceed?</h5>
                       <li class="page-header-title">Our shipments go through rigorous quality check processes before they leave our warehouse. However, in the rare case that your product is damaged during shipment or transit, you can request a replacement or cancellation and refund. </li>
                        <li class="page-header-title">If you have received an item in a damaged/defective condition or have been sent a wrong product, you can follow a few simple steps to initiate your return/refund within 5 days of receiving the order: </li>
                        <p>Step 1: Contact our Customer Support team via email (enquiry@baptisthealthcare.in) within 5 business days of receiving the order. </p>
                        <p>Step 2: Provide us with your order ID details and your request to return/replace/refund the defective/wrong items in your order. Kindly share an image of the product and the invoice for our reference.</p>
                        <p>Step 3: We will pick up the products within 2-4 business days. We will initiate the refund or replacement process only if the products are received by us in their original packaging with their seals, labels, and barcodes intact.</p>
                        <li class="page-header-title">Note: If it is a case of replacement, it is subject to the availability of stock. In case that a replacement may not be available, we will refund you the full amount.</li>
                        <h5>Do I have to return the free product/gift when I return a product?</h5>
                        <li class="page-header-title">Yes. The free product/gift is included as a part of the item order and needs to be returned along with the originally delivered product.</li>
                        <h5>Can I return part of my order?</h5>
                        <li class="page-header-title">Yes. A return can be created at the item level and if you have ordered multiple items, you can initiate a return/replacement/refund for any individual item. However, any product being returned needs to be returned in full including all components as well as any complimentary gifts or products which came along with it.</li>
                        <h5>How will I get refunded for the returned orders and how long will this process take?</h5>
                        <li class="page-header-title">In case of a return/replacement/refund, we process the refund once the products have been received and verified at our warehouse.</li>
                        <li class="page-header-title">For payments done through credit/debit cards or net banking, the refund will be processed to the same account from which the payment was made within 24-48 business hours of us receiving the products back. It may take 2-3 additional business days for the amount to reflect in your account.</li>
                        <li class="page-header-title">For cash on delivery transactions, we will initiate a bank transfer against the refund amount against the billing details shared by you. This process will be completed within 24-48 business hours of us receiving the products back and your bank details on email. It will take an additional 2-3 business days for the amount to reflect in your account.</li>
                    </div>
