                ...
                <div class="card-body mb-4 mt-4" >
                            ...
                            <tr ><td class="blue">
                               TAX INVOICE
                                ...
                                <table style="width:100%" class="table">
                                  ...
                                  <tr>
                                    <td width="50%" rowspan="2">    <div class="company">
                                        <div class="company-logo">
                                        <img src="https://prrayashacollections.com/frontend/img/Prrayasha Collection LOGO.jpeg" width="150px;" class="squaree" alt="">
                                        </div>
                                    <div class="company-details">
                                        <h2 > Prrayasha Collections</h2>
                                        <p>GSTN : 33AWPPJ9059B2ZD </p>
                                        <p>Provident Cosmo City, DR Abdul Kalam Road,<br> Pudhupakkam Village, Chengalpet 603103</p>
                                        <p>+91 91590 24967</p>
                                    </div>
                                        </div></td>
                                    <td>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="15%" class="fw-bold text-end">₹{{number_format($datas->amount,2,'.','')}}</td>
                                            <!--<td></td>-->
                                            <td class="text-end" class="text-end">₹{{number_format(($datas->amount * $datas->quantity),2,'.','')}}</td>
                                        </tr>
                                         @endforeach
                                       
                                        <tr>
                                            <td></td>
                                            <td class="total-heading text-end">Total Amount - <small>Inc. all vat/tax</small> </td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td  class="total-heading text-end"> CGST {{$csGST}}% </td>
                                            <td colspan="1" class="total-heading"></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                         ...
                                         <tr>
                                            <td></td>
                                            <td  class="total-heading text-end"> SGST {{$csGST}}% </td>
                                            <td colspan="1" class="total-heading"></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end" colspan="2">₹{{number_format($delivery_charge,2)}}</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            ...
                                            <td class="text-end" colspan="2">₹{{number_format(($order->ship_discount_amount),2,'.','')}}</td>
                                        </tr>
                                          <tr>
                                            <td></td>
                                            ...
                                            <td class="text-end" colspan="2">₹{{number_format(($order->discound_amount),2,'.','')}}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end" colspan="2"> ₹{{number_format(($order->sub_total + $order->deliver_charge -$order->discound_amount-$order->ship_discount_amount),2,'.','')}}</td>
                                        </tr>
                                 ...
                                 Amount Chargable (in words): INR <?php echo numberToWords($total); ?>
                                    ...
                                    <table style="width:100%" class="table">
                                        <tr>
                                            ...
                                            <td width="50%" class="text-end">For Prrayasha Collection</td>
                                        </tr>
                        
                        
                                        <tr>
                                            <td class="text-center"> </td>
                                            <td class="text-end"  style="padding: 8px;font-size: 14px;"> <img width="20%" src="{{url('frontend/img/sign.jpg')}}"></td>
                                        </tr>
                    ...
                    <div class="row">
                         ...
                         <div class="btn-wrapper animated" style="text-align:center">
                            <a class="theme-btn-1 btn btn-effect-1 text-uppercase" type="button" class="btn-primary" id="printPageButton" onclick="window.print()">Print</a>
                        </div>
                    </div>
