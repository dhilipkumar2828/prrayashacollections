...
<div class="container mb-4">
   ...
   <div class="row">
      ...
      <div class="col-lg-7  contact-content">
         ...
         <p>We're delighted to assist you with any inquiries you may have about our exquisite collections of clothing and accessories. Our commitment is to provide exceptional service and ensure your experience with Prrayasha Collections is enjoyable. Please reach out to us if you have any questions or need assistance. We look forward to hearing from you!</p>
                  ...
                  <form id="contactForm" class="ltn__form-box contact-form-box" method="POST">
                    @csrf
                     <div class="mb-4">
                        ...
                        <input type="text" id="" placeholder="" class="form-control" name="name" required>
                     ...
                     <div class="mb-4">
                        ...
                        <input type="" id="inputemail" placeholder="" class="form-control" name="mobile" required>
                     ...
                     <div class="mb-4">
                        ...
                        <input type="email" id="inputemail" placeholder="" class="form-control" name="email" required>
   ...
   <div class="row">
      ...
      <div class="col-lg-4 m-mb-1 t-mb-1 t-mb-1">
         ...
         <div class="inquiries-card">
            ...
            <img src="{{asset('frontend/img/icons/mail.jpg')}}" width="100" class="m-3">

            <div class="inquiries-card-inner"><a class="" href="mailto:prayashacollections@gmail.com" rel="nofollow">prayashacollections@gmail.com</a> </div>
      ...
      <div class="col-lg-4 m-mb-1 t-mb-1">
         ...
         <div class="inquiries-card">
            ...
            <img src="{{asset('frontend/img/icons/location.jpg')}}" width="100" class="m-3">

            <div class="inquiries-card-inner">

             Provident Cosmo City, DR Abdul Kalam Road, Pudhupakkam Village, Chengalpet 603103
      ...
      <div class="col-lg-4 m-mb-1 t-mb-1">
         ...
         <div class="inquiries-card">
            ...
            <img src="{{asset('frontend/img/icons/phone.jpg')}}" width="100" class="m-3">

            <div class="inquiries-card-inner"><a class="phone" href="tel://+91 91590 24967">+91 91590 24967</a>  </div>
