            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="page-header-st3-content">
                        ...
                        <h2 class="page-header-title">{{isset($categories) ? $categories->title : 'All Products'}}</h2>
                ...
                <div class="col-md-6 justify-content-end d-flex">
                    ...
                    <div class="page-header-st3-content">
                        ...
                        <ol class="breadcrumb justify-content-center justify-content-md-start">
                            ...
                            <li class="breadcrumb-item active text-dark" aria-current="page">{{isset($categories) ?$categories->title : 'All Products'}}</li>
                            ...
                            <div class="product-sidebar-widget ">
                                ...
                                <div class="product-widget ">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="checkprice"
                                    ...
                                    <div class="price-show" >
                                        ...
                                        <input type="radio" class="form-check-input" id="radio-1" name="price_sort" value="high-to-low">
                                    ...
                                    <div class="price-show" >
                                        ...
                                        <input type="radio" class="form-check-input" id="radio-2" name="price_sort" value="low-to-high">
                                   ...
                                   <div class="product-widget ">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input type="radio" class="form-check-input" id="in_stock"
                                   ...
                                   <div class="product-widget ">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="size"
            ...
            <section class="d-none">
                ...
                <div class="container">
                    ...
                    <a href="{{url('product_list')}}" class="product-banner-item">
                        ...
                        <img src="{{asset('frontend/img/shop/banner/7.webp')}}" loading="lazy" width="1170" height="240" alt="Image-HasTech">
