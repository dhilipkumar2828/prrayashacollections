...
@endphp
                        ...
                        <div class="product-item single-productsBox">
                            ...
                            <div class="product-thumb product-image">
                                ...
                                <a class="d-block" href="{{url('products').'/'.$product->slug}}">
                                    ...
                                    <img src="{{url($aProductvariant_photo[$key])}}" alt="Image-HasTech" class="home_product_img product-first-image">
            ...
            ?>
              @if(count($newsizevariant)==0)
                                <div class="outofstock single" style="position: static;padding: 0px 39px;border: 1px solid #222e64;background: #222e64;color: #fff;width:100%;">
                                    <p>Out Of Stock</p>
                                </div>
                                 @endif
                            ...
                            <div class="product-item product-st3-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="{{url('products').'/'.$p->slug}}">
                                        <img src="{{url($p->photo)}}" width="370" height="450" alt="Image-HasTech">
                                    </a>
