...
<script>
 $('#owl-one').owlCarousel({
        ...
        responsive: {
            ...
            1000: {
                items: 5 // Keep 5 items for larger screens (1000px and up)
            }
        }
    });
</script>
...
if(name!="" && last_name !="" &&  email !="" && phone !="" && address !="" && city !="" &&  state !="" &&  postcode !=""){
           ...
           $.ajaxSetup({
            ...
            $.ajax({
                ...
                success:function(data){
                        ...
                        ttotal=tttotal.replace(/\,/g,''); // 1125, but a string, so convert it to number
                        ...
                        "amount": ttotal*100, // Amount is in currency subunits. Default currency is INR. Hence, 10 refers to 1000 paise
                        ...
                        "handler": function (response){
                            ...
                            $.ajax({
                                ...
                                data:{razorpay_payment_id:response.razorpay_payment_id,amount:total,payy_id:payy_id,oid:oid},
          ...
          success:function(data){
              ...
              if(data['status']){
                ...
                $('#add_to_wishlist_'+product_id).html('<i class="fa fa-heart whats_new_icon_'+product_id+'" style="color:red" ></i>');
                  ...
                  $('#add_to_wishlist_'+product_id).html('<i class="fa fa-heart whats_new_icon_'+product_id+'" style="color:none" ></i>');
      ...
      $.ajax({
          ...
          success:function(data){
            ...
            if(data['status']){
                     ...
                     $('.wish_1'+product_id).html('<i class="fa fa-heart icon1_'+product_id+'" style="color:red" ></i>');



                      $('.wish2'+product_id).html('<i class="fa fa-heart icon2_'+product_id+'" style="color:red" ></i>');
                      ...
                      //     });
                        ...
                        $('.wish_1'+product_id).html('<i class="fa fa-heart icon1_'+product_id+'" style="color:none" ></i>');



                      $('.wish2'+product_id).html('<i class="fa fa-heart icon2_'+product_id+'" style="color:none" ></i>');
        ...
        //   },
          ...
          success:function(data){
              ...
              if(data['status']){
                ...
                $('.wish_2'+product_id).html('<i class="fa fa-heart icon1_'+product_id+'" style="color:red" ></i>');
                ...
                $('.wish_2'+product_id).html('<i class="fa fa-heart icon1_'+product_id+'" style="color:none" ></i>');
...
<script>
  ...
  var product_option=$(this).attr('data-option');
    ...
    var product_option=$(this).attr('data-option');
        ...
        var product_option={color: 'default'};
      ...
      setTimeout(() => {
         ...
         $(".attrib_colrs ul li").click(function(e){
           ...
           // $('#id').attr('src', 'newImage.jpg');
             ...
             $('.add_to_cartid'+product_id+',.buynowid'+product_id).attr('data-option',JSON.stringify(optiondata));
             ...
             $.ajax({
                 ...
                 data: {
                     ...
                     option: option,product_id:product_id, _token: '{{csrf_token()}}'
                 ...
                 if(result['offer_price'] == 0 &&  result['offer_price'] != null){
                    ...
                    var img_val=result['image_values'][0]['photo'];
                     ...
                     $('.total-prince_'+product_id).html((result['offer_price']) ? (result['offer_price']*$('.input-numbers'+product_id).val()) : (result['original_price']*$('.input-numberssub_'+product_id).val()));



                     $('.total-prince_'+product_id).attr('data-price',(result['offer_price']) ? (result['offer_price']*$('.input-numbers'+product_id).val()) : (result['original_price']*$('.input-numberssub_'+product_id).val()));
                 ...
                 else if(result['original_price'] != 0 &&  result['original_price'] != null){
                 ...
                 }else if(result['original_price'] == null &&  result['original_price'] == null && selectedSize!="" ){
...
// alert(sort_price);
     ...
     $.ajax({
         ...
         data: {
             ...
             sort_price: sort_price, _token: '{{csrf_token()}}'
                ...
                $.ajax({
                    ...
                    success: function(result){
                     ...
                     if(result['offer_price'] == 0 &&  result['offer_price'] != null){
                        ...
                        $('.total-prince_'+product_id).html((result['offer_price']) ? (result['offer_price']*$('.input-numbersnewarrivals_'+product_id).val()) : (result['original_price']*$('.input-numbers'+product_id).val()));



                        $('.total-prince_'+product_id).attr('data-price',(result['offer_price']) ? (result['offer_price']*$('.input-numbersnewarrivals_'+product_id).val()) : (result['original_price']*$('.input-numbers'+product_id).val()));
...
if(data['success']==true){
    ...
    $('.wishlist_title_'+product_id).html('<i class="fa fa-check-square-o"></i> Added to wishlist successfully!');
 ...
 //   $("#action-WishlistModal_"+product_id).modal('show');
    ...
    $('.wishlist_title_'+product_id).html('<i class="fa fa-check-square-o"></i>Removed from wishlist successfully!');
...
$(document).on("click", ".nice-select .option:not(.disabled)", function (t) {
    ...
    var token=$('meta[name="csrf-token"]').attr('content');
                                ...
                                data:{product_id:prodid[0],arrtibute_name:(arr), _token:token},
    ...
    $('.product_rate_'+prodid[0]).html((data['saleprice']).toFixed(2) * Number(increment));
