        ...
        <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
            ...
            @if(!empty($youtube->photo))
                <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                        ...
                        <img src="{{ asset($youtube->photo) }}" loading="lazy" alt="{{ $youtube->photo }}" style="margin-left: 30px; width: 270px; height: 200px; object-fit: cover;border-radius: 15PX;"  class="img-fluid mb-3">
