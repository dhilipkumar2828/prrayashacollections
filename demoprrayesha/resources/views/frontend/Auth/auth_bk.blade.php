    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="{{route('register.sumbit')}}" class="form-horizontal" method="POST">
                ...
                <div class="infield">
                 <input type="text" id="register_phone_number" placeholder="Mobile Number" name="phone_number" required onkeypress="return isNumber(event)" minlength="10" maxlength="10">
        ...
        <div class="sentopt_screen">    
             <form action="{{route('login.sumbit')}}" class="form-horizontal" method="POST" name="mobPassForm">
                ...
                <div class="infield">
                  ...
                  <div class="infield">
                  <a  href="#" class="forgot otptextlog" id="sendOtpButton" onclick="sendotp(1)">Login with OTP</a>
                    <a href="{{url('forget_password')}}" class="forgot forgotpass">Forgot your password?</a>
                    </div>
               
                
                  <button  type="button" id="login_submit" class="default-btn w-100 mb-4" onclick="mobPassSubmit()">Sign In</button>
             ...
             <form action="{{route('verifyotp')}}"   method="POST">
                ...
                <div class="infield">
                   <input type="text" name="otp" placeholder="6 digit code" minlength="6" maxlength="6" pattern="[0-9]{6}" required>
                    ...
                    <div class="infield">
                   <a  href="#" class="forgot otptextlog" id="sendOtpButton" onclick="sendotp(2)">Login with OTP</a>
                    <a href="{{url('forget_password')}}" class="forgot forgotpass">Forgot your password?</a>
                    </div>
