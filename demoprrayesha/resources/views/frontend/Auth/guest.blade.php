...
<div class="right-section d-flex flex-column justify-content-between">
 ...
 <form action="{{route('guestverifyOtp')}}" class="form-horizontal" method="POST" name="mobPassForm">
     @csrf
     @php
    ...
    <div id="resendotpField" class="d-flex d-none">
        ...
        <p><span><a href="javascript:;" id="resentotpbtn" onclick="guestsendotp()">Resend OTP</a></span></p>
  ...
  <div class="otptext  mt-4">
    ...
    <div class="d-grid mb-3">
      <button class="btn btn-light rounded-pill fw-bold d-flex justify-content-center align-items-center gap-2"
        type="button" style="color: #080a54;" id="sendOtpButton" onclick="guestsendotp()">
