                    ...
                    <div class="row mb-n8">
                                            ...
                                            <div class="sentopt_screen">
                                               <form action="{{route('login.sumbit')}}" class="form-horizontal" method="POST">
                                                ...
                                                <div class="form-group mb-6">
                                                    ...
                                                    <input type="text" id="mobile" name="mobile" placeholder="Enter your mobile number" pattern="[0-9]{10}" required >
                                              ...
                                              <span class="text-danger password_err"></span>
                                                ...
                                                <button  type="submit" id="login_submit" class="default-btn w-100 mb-4">Login</button>
                                                    ...
                                                    <div class="form-check ms-3 ">
                                                        ...
                                                        <label class="form-check-label" for="remember_pwsd" id="sendOtpButton">Login with OTP</label>
                        ...
                        <div class="col-lg-6 mb-8">
                            ...
                            <div class="my-account-item-wrap">
                                ...
                                <p>Unlock shopping bliss by signing up for a free account today! Quick and easy registration grants you instant access to order from our shop. Create your account now and start shopping!</p>
                            ...
                            {{ csrf_field()}}
                                        ...
                                        <div class="form-group mb-6">
                                            ...
                                            <input type="text" id="register_phone_number" name="phone_number" required onkeypress="return isNumber(event)">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="button" id="register_submit" class="optional-btn">Create Account</button>
