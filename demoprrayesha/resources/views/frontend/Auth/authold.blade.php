     ...
     @csrf
                ...
                @endif
                 <form action="{{route('verifyotp')}}"   method="POST">
                                                  ...
                                                  @csrf
                <div class="infield" id="first_screen">
                    <input  type="text" id="mobile" name="mobile" placeholder="Enter your mobile number" minlength="10" maxlength="10"/>
                     <span class="text-danger mobile_err" style="color:red;"></span>
                    <label></label>
                </div>
                
                   <div class="infield" id="verify_screen" style="display:none;">
                        <input type="text" id="verifyphone" name="mobile" placeholder="Enter your mobile number" pattern="[0-9]{10}" required>
                   <input type="text" name="otp" placeholder="6 digit code" minlength="6" maxlength="6" pattern="[0-9]{6}" required>
               ...
               <div class="infield" style="display:none;">
                   <input type="text" id="guest_mobile" name="guest_mobile" placeholder="Enter your mobile number" pattern="[0-9]{10}" required minlength="10" maxlength="10">
...
<p>We will send you a 6 Digit Verification Code</p>
                  ...
                  <button  type="button" id="sendOtpButton" class="default-btn w-100 mb-4" onclick="sendotp(1)">Send OTP</button>
            <button type="button" class="default-btn w-100 mb-4" style="display:none;" id="verifyotpdiv" onclick="authVerifyOtp()">Verify OTP</button>
                <div class="social-containerr">
                    <p>Continue as a Guest Login ? <span><a href="{{url('guest/auth')}}">Here</a>
                        </span></p>
                      <p class="createtext"><a href="{{url('register')}}">Create an Account</a></p>
                </div>
