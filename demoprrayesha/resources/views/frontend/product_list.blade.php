                 ...
                 @php $relatedreview=($rela_val!=0) ? 2 : 0; @endphp
                    ...
                    <div class="col-6 col-lg-4 col-md-6 mb-1 mb-sm-9">
                        ...
                        <div class="product-item single-productsBox">
                            ...
                            <div class="product-thumb product-image">
                                ...
                                <a class="d-block" href="{{url('products').'/'.$product->slug}}">
                                    ...
                                    <img src="{{url($aProductvariant_photo[$product->id])}}" loading="lazy" alt="Image-HasTech" class="home_product_img product-first-image">

                                    <img src="{{url($ahover_image_photo[$product->id])}}" loading="lazy" class="product-hover-image" alt="image">
                                ...
                                @if($aDiscountpercent[$key] !=0)
                                    ...
                                    <span>{{number_format($ADiscountpercent,2,'.','')}} <?php echo $discount; ?></span>
                                    ...
                                    <button type="button" data-product_id="{{$product->id}}"
                                       ...
                                       @php
                                        ...
                                        @if($currentUser && isset($iswishlist[$key]) && $iswishlist[$key] === 'yes')
                                           <i class="fa fa-heart heart_icon{{$product->id}}"  style="color:red;"></i>
                                ...
                                <h4 class="title"><a href="{{url('products').'/'.$product->slug}}">{{$product->name}}</a></h4>
                                 ...
                                 <div class="prices d-flex justify-content-center  align-items-center">
                                  ...
                                  <div class="position-relative">
                                              ...
                                              @endif
                                              <span class="price"><span>₹</span>{{ number_format($price,2,'.','') }}</span>
                                </div>
                                </div>
                            ...
                            ?>
                              @if(count($newsizevariant)==0)
                                <div class="outofstock single" style="padding: 0px 39px;border: 1px solid #222e64;background: #222e64;color: #fff;width:100%;">
                                 ...
                                 @endif
                             <h6 style="#364958">Available Variants</h6>
                        ...
                        <?php
                          ...
                          ?>
                                   <div class="size-buttons-tipAndBtnContainer" style="<?php echo $style; ?>"> <!-- Apply inline style here -->
                    <div class="size-buttons-buttonContainer">
                        <button class="sizes-buttons-size-button new-class round-button">
                            ...
                            <p class="size-buttons-unified-size"><?php echo $vals->variants; ?></p>
                        </button>
                    </div>
                </div>
                         <?php }} ?>
