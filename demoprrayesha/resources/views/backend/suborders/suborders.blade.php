                                ...
                                <td>
                                    <div class="btn-group m-b-10">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="{{url('suborders_items/'.$item->id)}}"  class="btn waves-effect waves-light" 
                                                >View</a><br>
                                                
                                                <a class="btn waves-effect waves-light" onclick=edit("{{$item->id}}")  data-toggle="modal" data-dismiss="modal"
                                                data-target=".bs-example-modal-center1"
                                                >Edit</a>
                        ...
                        <div class="modal fade bs-example-modal-center1" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form  action="{{ route('update_suborders.update_suborders') }}" method="post" enctype="multipart/form-data">
                                           @csrf
                                            <div class="row">
                                             <div class="col-md-6">
                                                 <div class="form-group row">
                                                     ...
                                                     <div class="col-sm-10">
                                                        <input type="hidden" id="hidden_id" name="id">
                                                         <input class="form-control" id="order_id" type="text" value="" placeholder="Enter Name" disabled id="example-text-input">
                                                     </div>
                                                 </div>
                                                 </div>
                                                 <div class="col-md-6">
                                                 <div class="form-group row">
                                                     <label for="example-text-input" class="col-sm-12 col-form-label">Vendor Name</label>
                                                     <div class="col-sm-10">
                                                         <input class="form-control" id="vendor_name" type="text" value="" disabled placeholder="Enter Name"  id="example-text-input">
                                                     </div>
                                                 </div>
                                             </div>
                                             <div class="col-md-6">
                                                 <div class="form-group row">
                                                     ...
                                                     <div class="col-sm-10">
                                                        <input class="form-control" id="customer_name" type="text" value="" disabled placeholder="Enter Name"  id="example-text-input">
                                                     </div>
                                                 </div>
                                             </div>
                                             <div class="col-md-6">
                                                 <div class="form-group row">
                                                     <label for="example-text-input" class="col-sm-12 col-form-label">Payment Status</label>
                                                     <div class="col-sm-10">
