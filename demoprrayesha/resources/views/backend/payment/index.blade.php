                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-6 col-form-label">Display Cash
                                                On Delivery</label>
                                            <div class="col-sm-10">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input id="thumbnail" class="form-control" type="text"
                                                        value="{{@$citem[0]['image']}}" name="image">
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-6 col-form-label">Enter
                                                Text</label>
                                            <div class="col-sm-10">
                        ...
                        <form action="{{route('Stripe')}}" method="post">
                            ...
                            <div class="card shadow p-3 mb-3">
                                ...
                                <div class="row ">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-6 col-form-label">Display
                                                Stripe</label>
                                            <div class="col-sm-10">
                                                <input type="checkbox" name="status" value="on"
                                                    data-toggle="switchbutton" data-onlabel="on" data-offlabel="off"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-6 col-form-label">Stripe
                                                Key</label>
                                            <div class="col-sm-10">
                        ...
                        <form action="{{route('Paypal')}}" method="post">
                            ...
                            <div class="card shadow p-3 mb-3">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-6 col-form-label">Paypal
                                                Client ID</label>
                                            <div class="col-sm-10">
                        ...
                        <form action="{{route('RazorPay')}}" method="post">
                            ...
                            <div class="card shadow p-3 mb-3">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-6 col-form-label">RazorPay
                                                Key</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text"
                        ...
                        <form action="{{route('Display_Paytm')}}" method="post">
                            ...
                            <div class="card shadow p-3 mb-3">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-6 col-form-label">Paytm
                                                Mercent</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-6 col-form-label">Paytm Is
                                                Paytm</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-6 col-form-label">Paytm Paytm
                                                Mode</label>
                                            <div class="col-sm-10">
                        ...
                        <form action="{{route('SSL_Commerz')}}" method="post">
                            ...
                            <div class="card shadow p-3 mb-3">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-6 col-form-label">SSLCommerz
                                                Store Id</label>
                                            <div class="col-sm-10">
