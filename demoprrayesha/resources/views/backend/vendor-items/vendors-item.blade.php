                                                        ...
                                                        <td>
                                                            <div class="btn-group m-b-10">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    <a class="dropdown-item" href="{{ route('vendoritem.edit',$items->id)}}">Edit</a>
                                                                    @endcan
                                                                    ...
                                                                    <a class="btn waves-effect waves-light view" data-toggle="modal" data-id="{{ $items->id }}|{{route('vendoritem.show',$items->id)}}" data-dismiss="modal"
                                                                    ...
                                                                    <!-- <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="vendor_item_id"  disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="productname" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-6 col-form-label">Product Attribute Details</label>
                                                                                <div class="col-sm-12">
...
$.each(attributedata, function( index, value ) {
 ...
 details +='<tr><td>'+(index+1)+'</td><td>'+value.attribute_name+'</td><td>'+value.attribute_value+'</td><td>'+value.quantity+'</td><td>'+value.buying_price+'</td><td><span class="status badge '+sta+'">'+value.status+'</span></td></tr>';
});
