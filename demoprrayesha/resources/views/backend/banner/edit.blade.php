                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="category" id="category" required>
                                            ...
                                            ?>
                                            <option value="<?php echo $val->slug ?>" <?php echo $selected; ?>><?php echo $val->title; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" required type="text" name="photo" value="{{$banner->photo}}">
                                          </div>
                                          <div id="holder" style="margin-top:15px;max-height:100px;"><img src="{{$banner->photo}}" alt="promo image"style="max-height: 90px;max-width:120px">
                                          </div>
                                        </div>
                                    </div>

 <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Mobile Image</label>
                                    <!-- <img src="assets/images/image.png" class="admin-image"> -->
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-btn">
...
{{--
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" required name='status' value="{{$banner->status}}">
