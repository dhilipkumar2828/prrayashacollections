                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                @foreach($purchaseorder as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <select class="form-control status" name="status" data-id="{{$item->id}}">
                                                           <option value="">Status</option> 
                                                    <option value="Ordered" {{ ($item->status == 'Ordered') ? 'selected' : '' }}>Ordered</option>    
                                                    <option value="Partially received" {{ ($item->status == 'Partially received') ? 'selected' : '' }}>Partially received</option>    
                                                    <option value="Products received" {{ ($item->status == 'Products received') ? 'selected' : '' }}>Products received</option>    
                                                    ...
                                                    <option value="Refused" {{ ($item->status == 'Refused') ? 'selected' : '' }}>Refused</option>    
                                                        ...
                                                        <td>
                                                            <div class="btn-group m-b-10">
                                                                <button type="button" class="btn btn-action dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" style="margin-top: 14px;"
                                                                    aria-expanded="false">Actions</button>
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="{{route('purchaseorder.show',$item->id)}}">Edit</a>
                                                                    @if(\App\Models\Invoice::where(['purchase_order_id'=>$item->id])->count() != 1)
                                                                    <form action="{{route('purchaseorder.edit',$item->id)}}" >
                                                                      @csrf

                                                                    <button class="btn waves-effect waves-light order" type="submit" 
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label">Purchase Request</label>
                                                                                <div class="col-sm-10">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label">PO Number</label>
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="example-text-input" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label">PO Description</label>
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="example-text-input" disabled>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="date" placeholder="Enter " id="example-text-input" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label" >Delivery Date</label>
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="date" placeholder="Enter " id="example-text-input" disabled>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label">Brand</label>
                                                                                <div class="col-sm-10">
                                                                                    <select name="" id="" class="form-control" disabled>
                                                                                        <option value="">  </option>
                                                                                        <option value=""> </option>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label">Unit</label>
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="example-text-input" disabled>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label">PO Amount</label>
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="example-text-input" disabled>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label">Tax Value</label>
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="example-text-input" disabled>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                <label for="example-text-input" class="col-sm-12 col-form-label">Total Amount</label>
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="example-text-input" disabled>
                                                                                </div>
                                                                            </div>
