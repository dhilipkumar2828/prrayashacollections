                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                @if(!empty($item->invoice_id))
                                                    <tr>
                                                        ...
                                                        <td>{{$item->payment}}</td> 
                                                        <td><a data-url="{{asset('uploads/invoices/'.$item->invoice_link)}}" class="btn waves-effect waves-light invoicepdf" style="color:red;" data-toggle="modal" data-dismiss="modal"
                                                                        data-target=".bs-example-modal-center1" >{{$item->invoice_id.".pdf"}}</a></td> 
