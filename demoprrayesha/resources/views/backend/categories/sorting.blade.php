                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                               <tr>
                                  <td>1</td>
                                  <td>Home Page</td>
                                  <td><a href="{{url('category_sorting/homepage')}}"><button class="btn btn-primary">Sort</button></a></td>

                               </tr>
                               <tr>
                                  <td>2</td>
                                  <td>Header Page</td>
                                  <td><a href="{{url('category_sorting/headerpage')}}"><button class="btn btn-primary">Sort</button></a></td>
