                                                ...
                                                @foreach ($tax as $item )
                                                    <tr>
                                                        ...
                                                        <td> {{ $item->percentage}} </td>
                                                          @if(auth()->user()->can('tax-edit'))
                                                        <td><input type="checkbox" name="toogle" class="status" value="{{$item->id}}"
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    @can('tax-edit')
                                                                    <a class="dropdown-item" href="{{route('tax.edit',$item->id)}}">Edit</a>
                                                                   @endcan
                                                                   
                                                                   <?php 
                                                                    if($item->tax_name !="Gst"){
                                                                    ?>
                                                                    <form action="{{route('tax.destroy',$item->id)}}" method="post" id="form{{$item->id}}">
                                                                        @csrf
                                                                        @method('delete')
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>You are going to delete this Tax. All contents related with this Tax will be lost. Do you want to delete it?</p>
                                                            </div>
