...
@section('content')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" required type="text" name="photo" value="{{$advertisement->photo}}">
                                          </div>
                                          <div id="holder" style="margin-top:15px;max-height:100px;"><img src="{{$advertisement->photo}}" alt="promo image"style="max-height: 90px;max-width:120px">
                                          </div>
                                        </div>
                                    </div>
    ...
    <div class="col-sm-10">
        <select id="Position" name="position" class="form-control" required>
            ...
            <option value="1" {{ $advertisement->position == '1' ? 'selected' : '' }} >Advertisement 1</option>
            <option value="2"  {{ $advertisement->position == '2' ? 'selected' : '' }} >Advertisement 2</option>
...
{{--
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" required name='status' value="{{$advertisement->status}}">
