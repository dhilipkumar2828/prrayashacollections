                ...
                <div class="card-body">
                    ...
                    <thead>
                        ...
                        ?>
                            ...
                            <td>{{ $value->coupon_name}}<br><span class="badge badge-success">{{($type)}}</span></td>
                            ...
                            <td>{{ $value->coupon_code}}</td>
                                ...
                                @if(auth()->user()->can('coupon-edit')) 
                                <td>
                                <input type="checkbox" name="toogle"  value="{{$value->id}}" data-toggle="switchbutton" {{$value->Status=='active' ? 'checked':''}} data-onlabel="active" data-offlabel="inactive" data-size="sm" data-onstyle="success" data-offstyle="danger">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group m-b-10">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                @can('coupon-delete')
                                                    <form action="{{route('coupon.destroy',$value->id)}}" id="form-{{$value->id}}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                            @can('coupon-delete')
                                                            <a class="dltBtn btn waves-effect waves-light " title="delete" data-id="{{$value->id}}" data-toggle="modal" data-dismiss="modal" data-target=".bs-example-modal-center">Delete</a>
                                                            @endcan
                                                        </form>
                                                @endcan
                                                <!-----
                                                @can('coupon-view')
                                                    <a class="btn waves-effect waves-light view" data-toggle="modal"  data-id="{{$value->id}}"   data-dismiss="modal"
                                        ...
                                        <form>
                                            ...
                                            <div class="col-md-6">
                                                 <div class="form-group row">
                                                     <label for="example-text-input" class="col-sm-12 col-form-label">Coupon Name</label>
                                                     <div class="col-sm-10">
                                                         <input class="form-control" type="text" id="coupon_name" placeholder="Enter Name" disabled id="example-text-input">
                                                     </div>
                                                 </div>
                                                 </div>
                                             <div class="col-md-6">
                                                 <div class="form-group row">
                                                     <label for="example-text-input" class="col-sm-12 col-form-label">Coupon Code</label>
                                                     <div class="col-sm-10">
                                                         <input class="form-control" type="text" id="coupon_code" placeholder="Enter Code" disabled id="example-text-input">
                                                     </div>
                                                 </div>
                                                 </div>
                                             ...
                                             <div class="col-md-6">
                                                 <div class="form-group row">
                                                     ...
                                                     <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="start_date" placeholder="Enter Name" disabled id="example-text-input">
                                                     </div>
                                                 </div>
                                             </div>
                                             <div class="col-md-6">
                                                 <div class="form-group row">
                                                     ...
                                                     <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="end_date" placeholder="Enter Name" disabled id="example-text-input">
                                                     </div>
                                                 </div>
                                             </div>
                                             <div class="col-md-6">
                                                 <div class="form-group row">
                                                     <label for="example-text-input" class="col-sm-6 col-form-label">Discount Values</label>
                                                     <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="value" placeholder="Enter value" disabled id="example-text-input">
                                                     </div>
                                                 </div>
                                             </div>
                                             <div class="col-md-6">
                                                 <div class="form-group row">
                                                     ...
                                                     <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="type" placeholder="Enter type" disabled id="example-text-input">
                                                     </div>
                                                 </div>
                                             </div>
                                             <div class="col-md-6">
                                                 <div class="form-group row">
                                                     ...
                                                     <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="minimum_order_amount" placeholder="Enter Minimum order amount" disabled id="example-text-input">
                                                     </div>
                                                 </div>
                                             </div>
