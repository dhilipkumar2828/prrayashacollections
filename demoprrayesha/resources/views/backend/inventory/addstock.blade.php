...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="card m-b-30 card-body">
            ...
            <a href="{{route('product.listproduct')}}" id="add-btn" style="color: #ffffff;"><i class="fa fa-angle-left"
                ...
                <div class="card m-b-30">
                    ...
                    @csrf
                        <div id="product_attribute" class="content"
                            ...
                            <div class="col-md-12">
                                <img src="{{$Product->photo}}" alt="" style="max-height: 250px;max-width:250px" id="photo">
                            </div>
                            <div class="col-md-6">
                                                    <div class="row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label" style="font-size: 20px"><b>Summary:</b></label>
                                                        <div class="col-sm-10" id="summary"><p>{!! $Product->summary !!}</p></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label" style="font-size: 20px"><b>Description:</b></label>
                                                        <div class="col-sm-10" id="summary"><p>{!! $Product->description !!}</p></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label" style="font-size: 20px"><b>Brand Name:</b></label>
                                                        <div class="col-sm-10" id="summary"><p>{{$Product->brand_name}}</p></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label" style="font-size: 20px"><b>MPN:</b></label>
                                                        <div class="col-sm-10" id="summary"><p>{{$Product->mpn}}</p></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label" style="font-size: 20px"><b>GTIN:</b></label>
                                                        <div class="col-sm-10" id="summary"><p>{{$Product->gtin}}</p></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label" style="font-size: 20px"><b>GTIN Type:</b></label>
                                                        <div class="col-sm-10" id="summary"><p>{{$Product->gtin_type}}</p></div>
                                                    </div>
                                                </div>
                                              
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label" style="font-size: 20px"><b>Category:</b></label>
                                                        <div class="col-sm-10" id="summary"><p>{{$Product->category->title}}</p></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label" style="font-size: 20px"><b>Manufactured:</b></label>
                                                        <div class="col-sm-10" id="summary"><p>{{$Product->brand->title}}</p></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <label for="example-text-input" class="col-sm-12 col-form-label" style="font-size: 20px"><b>Tax:</b></label>
                                                        <div class="col-sm-10" id="summary"><p>{{$Product->tax_value}}%</p></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">  
                                                <div class="row">         
                                       <div class="col-md-6">
                                        <div class="form-group ">
                                            <label for="example-text-input" class="col-form-label">Warehouse</label>
                                            <select class="form-control form-control-sm " name="warehouse_id" required
                                                 >
                                                <option value="">Warehouse</option>
                                                @foreach (\App\Models\Warehouse::distinct()->get() as
                                                $ware)
                                                <option value="{{$ware->id}}" {{($Product->warehouse_id == $ware->id) ? 'selected' : '' }}>{{$ware->warehouse_code.' - '.$ware->warehouse_name}}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label for="example-text-input" class="col-form-label">Suppliers</label>
                                            <select class="form-control form-control-sm" name="supplier_id" required
                                                 >
                                                <option value="">Suppliers</option>
                                                @foreach (\App\Models\Suppliers::distinct()->get() as
                                                $sup)
                                                <option value="{{$sup->id}}" {{($Product->supplier_id == $sup->id) ? 'selected' : '' }}>{{$sup->supplier_id.' - '.$sup->supplier_name}}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('product.attribute.destroy',$item->id)}}"
                                                ...
                                                @csrf
                                                @method('delete')
                                                <button><a class="dltBtn btn waves-effect waves-light" title="delete"
    ...
    $('.variant1').removeClass('d-none');
            if (attr.indexOf(cat_id) == -1) {
                ...
                $.ajax({
                    ...
                    '<select class="chil_cat_id"  name="attribute_value_'+cat_id+'[]" id="chil_cat_id' + i +
    ...
    $.ajax({
                    ...
                    if (variant.indexOf(data.variant_id) == -1) {
                        ...
                        let details = '<div class="card border1" id="vchild' +data.variant_id +
                            ...
                            '<div class="col-md-3">' +
                            '<div class="form-group">' +
                            '<label for="example-text-input" class="col-sm-12 col-form-label">#' + data.variant_id + ' ' + arrtibute_name[0].replace('"','') + '</label>' +
                            '</div>' +
                            '</div>' +

                            '<div class="col-md-3">' +
                            '<div class="form-group">' +
                            '<label for="example-text-input" class="col-sm-12 col-form-label">' + arrtibute_name[1].replace('"','') + '</label>' +
                            '</div>' +
                            '</div>' +
                            ...
                            '<div class="col-md-12" style="display:none;" id="vo' + data.variant_id +'">' +
                            '<div class="row" >' +
                            '<div class="col-md-3 ml-3">' +
                            '<div class="form-group">' +
                            '<label for="example-text-input" class="col-form-label">SKU:</label>' +
                            '<input type="text"  class="form-control" name="sku[]" required placeholder="SKU" value="'+data.sku+'" style="width:100%;" >' +
                            '<input type="hidden"  class="form-control" name="variant_id[]" value="'+data.variant_id+'" style="width:100%;" >' +
                            '<input type="hidden"  class="form-control" name="attribute_value[]" value="'+arrtibute_name[0].replace('"','')+','+arrtibute_name[1].replace('"','')+'" style="width:100%;" >' +
                            '</div>' +
                            '</div>' +
                            '<div class="col-md-3">' +
                            '<label for="example-text-input" class="col-form-label">Image</label>' +
                            '<div class="input-group">' +
                            '<span class="input-group-btn">' +
                            '<a id="lfm" data-input="thumbnail' + data.variant_id + '" data-preview="holder' + data.variant_id + '" class="btn btn-primary lfm">' +
                            '<i class="fa fa-picture-o"></i> Choose' +
                            '</a>' +
                            '</span>' +
                            '<input id="thumbnail' + data.variant_id +
                            '" required value="'+data.photo+'" class="form-control" type="text" name="photo[]">' +
                            '</div>' +
                            ...
                            '<div class="form-group">' +
                            '<label for="example-text-input" class="col-form-label">Regular Price:</label>' +
                            '<input type="text"  class="form-control" value="'+data.regular_price+'" name="regular_price[]" required placeholder="Regular Price" style="width:100%;" >' +
                            '</div>' +
                            '</div>' +
                            '<div class="col-md-3 ml-3">' +
                            '<div class="form-group">' +
                            ...
                            '<div class="form-group">' +
                            '<label for="example-text-input" class="col-form-label">Stock:</label>' +
                            '<input type="text"  class="form-control" name="stock[]" value="'+data.stock+'" placeholder="Stock" style="width:100%;" >' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                    ...
                    let details = '<div class="card border1"  id="vchild' + data.variant_id + '"><div class="row">' +
                        '<div class="col-md-3">' +
                        '<div class="form-group">' +
                        ...
                        '<div class="col-md-6">' +
                        '<label for="example-text-input" ></label>' +
                        '<button type="button" class="tn btn-sm my-2 btn-danger pull-right mr-1" id="' + data.variant_id +
