                            ...
                            <form action="{{route('deals_update')}}" method="POST">
                              ...
                              <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Event Date and Time</label>
                                    ...
                                    <input type='text' class="form-control"  required  value="{{$deals->days}}" name="days" />
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label" ><span class="text-danger"></span>Event Description</label>
