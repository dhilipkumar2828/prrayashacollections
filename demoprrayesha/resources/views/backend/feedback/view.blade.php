                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <td>{{$feedback->phone_number}}</td>
                                    ...
                                    <td><input type="checkbox" name="toogle" value="{{$feedback->id}}" data-toggle="switchbutton" {{$feedback->status=='active' ? 'checked':''}} data-onlabel="active" data-offlabel="inactive" data-size="sm" data-onstyle="success" data-offstyle="danger"></td>
                                    @if(auth()->user()->can('Client Feedback Delete'))
                                    <td>
                                        <div class="btn-group ">
                                            ...
                                            <form action="{{url('delete_feedback').'/'.$feedback->id}}" method="post">
                                                    @csrf                              
                                                    <a class="dltBtn btn waves-effect waves-light"  title="delete" data-id="{{$feedback->id}}" data-toggle="modal" data-dismiss="modal" data-target=".bs-example-modal-center">Delete</a><br>
                                            </form>    
                                            </div>
                                        </div>
                                    </td>
