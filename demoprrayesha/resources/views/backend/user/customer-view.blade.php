...
<div class="col-lg-6">
                                <div class="form-group ">
                                    <label for="example-text-input" class="col-sm-10 col-form-label">Mobile Number</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="Enter Name"
...
<div class="col-lg-12">
<label for="example-text-input" class="col-sm-12 col-form-label"><b>Billing Address</b></label>
...
<div class="col-lg-12">
<label for="example-text-input" class="col-sm-12 col-form-label"><b>Shipping Address</b></label>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="Enter Name"
                                            ...
                                            id="example-text-input" name="name" value="{{ $customer->saddress }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="Enter Name"
                                            ...
                                            id="example-text-input" name="name" value="{{ $customer->scountry }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="Enter Name"
                                            ...
                                            id="example-text-input" name="name" value="{{ $customer->spostcode }}">
                                    </div>
                                </div>
...
<div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        <span class="badge {{ ($customer->name == 'active') ? 'badge-success' : 'badge-danger'}}">{{$customer->status}}</span>
                                    </div>
                                </div>
