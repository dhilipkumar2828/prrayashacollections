                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control required" type="text" value="{{$offer->photo}}" value="{{old('photo')}}" name="photo">        
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$offer->link}}" class="form-control" id="link" name="link" required>
