                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" required type="text" placeholder="Enter Category" id="example-text-input" name="title"value="{{ old('title') }}">
                            </div>
                        </div>
                        {{-- <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" placeholder="Meta Title" id="example-text-input" name="met_title"value="{{ old('met_title') }}">
                            </div>
                        </div> 
