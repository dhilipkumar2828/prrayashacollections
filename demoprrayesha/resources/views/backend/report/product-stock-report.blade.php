                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                @foreach($productstockreport as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{\App\Models\ProductAttribute::where('product_id',$item->product_id)->get()[0]->stock}}</td>
                                                        <td class="text-center">
                                                            <table>
                                                                <thead class="border-0">
                                                                    <th class="border-0">  <td>{{$item->open_stock}}</td></th>
                                                                    <th class="border-0">  <td>{{$item->product_price}}</td></th>
                                                                </thead>
                                                            </table>
                                                        </td>
                                                        <td class="text-center">
                                                            <table>
                                                                <thead class="border-0">
                                                                    <th class="border-0">  <td>{{$item->quantity}}</td></th>
                                                                    <th class="border-0">  <td>{{$item->buying_price}}</td></th>
                                                                </thead>
                                                            </table>
                                                        </td>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form>
                                                                    <div class="row">
                                                                     <div class="col-md-6">
                                                                         <div class="form-group row">
                                                                             <label for="example-text-input" class="col-sm-12 col-form-label">Product ID</label>
                                                                             <div class="col-sm-10">
                                                                     ...
                                                                     <div class="col-md-6">
                                                                         <div class="form-group row">
                                                                             <label for="example-text-input" class="col-sm-6 col-form-label">Date</label>
                                                                             <div class="col-sm-10">
                                                                                <input class="form-control" type="text" placeholder="Enter " disabled id="example-text-input">
                                                                             </div>
                                                                         </div>
                                                                     ...
                                                                     <div class="col-md-6">
                                                                         <div class="form-group row">
                                                                             <label for="example-text-input" class="col-sm-6 col-form-label">Tax Value</label>
                                                                             <div class="col-sm-10">
                                                                                <input class="form-control" type="text" placeholder="Enter " disabled id="example-text-input">
                                                                             </div>
                                                                         </div>
                                                                     ...
                                                                     <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            <label for="example-text-input" class="col-sm-6 col-form-label">Amount</label>
                                                                            <div class="col-sm-10">
                                                                               <input class="form-control" type="text" placeholder="Enter " disabled id="example-text-input">
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            <label for="example-text-input" class="col-sm-6 col-form-label">Total Amount</label>
                                                                            <div class="col-sm-10">
                                                                               <input class="form-control" type="text" placeholder="Enter " disabled id="example-text-input">
                                                                            </div>
                                                                        </div>
