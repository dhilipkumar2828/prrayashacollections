             ...
             -->
                                            <div class="table-rep-plugin">
                                                ...
                                                <table id="tech-companies-1" class="table table-striped table-height">
                                                        ...
                                                        <tr class="year">
                                                            <th class="tax"><span class="co-name">Net Amount<br>(Subtotal)</span></th>
...
<script>
    setTimeout(() => {
        $('.btn-toolbar').after(' <a href="javascript:void(0);" class="btn btn-primary downloadpdf"  type="button">PDF</a><a href="" id="pdffile" download style="display:none" ></a>');   
