                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                   @foreach($suppliers as $item)
                                                    <tr>
                                                        <td><img src="{{$item->logo}}" class="img img-responsive" style="width:25%;"></td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group m-b-10">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                     @can('Supplier Edit')
                                                                    <a class="dropdown-item" href="{{ route('suppliers.edit',$item->id) }}">Edit</a>
                                                                   @endcan
                                                                    <form action="{{route('suppliers.destroy',$item->id)}}" id="form-{{$item->id}}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                     @can('Supplier Delete')
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="supplier_id"  disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                    <input class="form-control" type="text" placeholder="Enter " id="supplier_name" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
