...
.sub-menu{padding:0 20px!important; display:none; list-style:none;}
.has_sub ul li.active ul{display:block!important;}
.has_sub ul li.active ul li a{color:#000!important;}
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-left	d-none d-lg-block">
                            <div class="text-center">
                                <!----
                                <a href="{{route('admin')}}" class="logo"><img src="{{asset('frontend/img/logo.png')}}" height="70" alt="logo" style="padding: 6px"></a>
                                --->
                                
                                  <a href="{{route('admin')}}" class="logo" style="color: #ffffff;font-size:20px;font-weight:bold;">Prrayasha Collections</a>
                            </div>
                        </div>
