                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            @foreach ($shipping as $item )
                                <tr>
                                    ...
                                    <td>{{$loop->shipping_address}}</td>
                                    <td>{{$loop->deliver_time}}</td>
                                    <td>{{number_format($shipping->deliver_charge,2)}}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group m-b-10">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="shipping-create.html">Edit</a>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" placeholder=""
                                                                    disabled id="example-text-input">
                                                            </div>
                                                        </div>
                                                    </div>
