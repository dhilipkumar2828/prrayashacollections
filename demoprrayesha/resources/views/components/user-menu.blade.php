                ...
                <div class="card mini-stat m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-muted">
                            ...
                            <h5 class="m-0">{{\App\Models\Category::count()}}<i class="mdi mdi-arrow-up text-success ml-2"></i></h5>
                ...
                <div class="card mini-stat m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-muted">
                            ...
                            <h5 class="m-0">{{\App\Models\Brand::count()}}<i class="mdi mdi-arrow-up text-success ml-2"></i></h5>
